...
function RouteListComponent_For_1_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", item_r1 == null ? null : item_r1.path);
    \u0275\u0275advance();
    \u0275\u0275property("src", item_r1 == null ? null : item_r1.largeImage, \u0275\u0275sanitizeUrl)("alt", item_r1 == null ? null : item_r1.title);
    \u0275\u0275advance(2);
...
var RouteListComponent = class _RouteListComponent {
  ...
  static {
    ...
    }, dependencies: [RouterLink], styles: ["\n[_nghost-%COMP%] {\n  --%NS%width: 40rem;\n  --%NS%heigth: 6rem;\n  display: grid;\n  max-height: 98vh;\n  overflow: auto;\n  justify-content: start;\n  grid-template-columns: repeat(auto-fit, minmax(var(--%NS%width), 1fr));\n  grid-template-rows: var(--%NS%height);\n  gap: 1rem;\n}\nsection[_ngcontent-%COMP%] {\n  display: block;\n  width: 100%;\n  height: var(--%NS%heigth);\n  padding: 0rem;\n  border-radius: 1rem;\n  background-color: #1d171d;\n  box-shadow: 0 0 1rem rgba(0, 0, 0, 0.5);\n  border: 1px solid #000;\n}\na[_ngcontent-%COMP%] {\n  display: flex;\n  width: 100%;\n  height: var(--%NS%heigth);\n  flex-direction: row;\n  justify-content: flex-start;\n  align-items: flex-start;\n  text-decoration: none;\n  color: #fff;\n  font-size: 1.5rem;\n  font-weight: bold;\n  transition: all 0.3s ease-in-out;\n}\nh2[_ngcontent-%COMP%] {\n  padding: 0 1rem;\n}\nimg[_ngcontent-%COMP%] {\n  height: var(--%NS%heigth);\n  aspect-ratio: 16/9;\n  border-radius: 1rem 0 0 1rem;\n}"] });
  }
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RouteListComponent, { className: "RouteListComponent", filePath: "src/app/route-list/route-list.component.ts", lineNumber: 27 });
})();
export {
  RouteListComponent
};
