import{a as Y}from"./chunk-EX27PMDL.js";import{i as H,k as J}from"./chunk-7UTYY7SV.js";import{B as g,C as I,G as L,Ga as j,Gb as q,Ib as M,Jb as T,L as k,R as N,Sa as U,T as $,V as P,Wa as u,Za as O,cb as z,eb as h,f as b,fb as f,ga as B,gb as y,h as A,hb as S,i as E,lb as D,o as m,ob as K,pa as G,pb as w,qa as R,tb as V,w as F}from"./chunk-VWKE6EEO.js";import"./chunk-G5KKTNWD.js";function W(s,r){if(s&1){let d=D();f(0,"article",3),K("click",function(){let e=G(d).index,c=w();return R(c.switch(e))}),S(1,"img",4),y()}if(s&2){let d=r.$implicit,t=r.index,n=w();V("large",n.largePositions[t]===1)("super",n.largePositions[t]===2),u(1),h("src",d.images[0]==null?null:d.images[0].link,j)}}var Q="e972ca06cc4b961",ne=(()=>{let r=class{constructor(t,n){this.http=t,this.ref=n,this.largePositions=Array.from({length:250},()=>Math.random()<.2?1:0),this.searchKey$=new b("kitten"),this.results$=this.searchKey$.pipe(g(e=>!!e),P(e=>this.http.get(`https://api.imgur.com/3/gallery/t/${e}`,{headers:{Authorization:`Client-ID ${Q}`}}).pipe(I(c=>A))),N("data","items"),g(e=>!!e),m(e=>e.filter(c=>[o.ImageJPEG,o.ImagePNG].includes(c.images&&c.images[0].type))),$(1))}setSearch(t){console.log(t)}switch(t){this.largePositions[t]+=1,this.largePositions[t]>2&&(this.largePositions[t]=0)}ngOnInit(){let t=this.ref.nativeElement;if(t){let n=t.getElementsByTagName("input")[0];E(import("./main.module-5JV3JPN4.js")).pipe(m(({wrapGrid:e})=>e(t.querySelector("#grid"))),P(()=>F(n,"input")),m(e=>e.target.value),L(400),k(),g(e=>e.length>0)).subscribe(this.searchKey$)}}},s=r;return(()=>{r.\u0275fac=function(n){return new(n||r)(O(Y),O(U))}})(),(()=>{r.\u0275cmp=B({type:r,selectors:[["app-tumblr"]],standalone:!0,features:[q],decls:6,vars:6,consts:[["type","search",3,"value"],["id","grid"],[3,"large","super","click",4,"ngFor","ngForOf"],[3,"click"],["loading","lazy",3,"src"]],template:function(n,e){n&1&&(f(0,"div"),S(1,"input",0),M(2,"async"),y(),f(3,"div",1),z(4,W,2,5,"article",2),M(5,"async"),y()),n&2&&(u(1),h("value",T(2,2,e.searchKey$)),u(3),h("ngForOf",T(5,4,e.results$)))},dependencies:[H,J],styles:[`root[_ngcontent-%COMP%] {
    --image-nth: 3;
  }
  [_nghost-%COMP%] {
    display: block;
