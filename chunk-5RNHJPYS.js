...
// node_modules/.pnpm/mermaid@11.16.1/node_modules/mermaid/dist/chunks/mermaid.core/chunk-RYQCIY6F.mjs
...
var extractor = /* @__PURE__ */ __name((graph, depth) => {
  ...
  for (const node of nodes) {
    ...
    if (!clusterDb.has(node)) {
      ...
      graph.setNode(node, __spreadProps(__spreadValues({}, clusterNodeData), {
        clusterNode: true,
        id: node,
