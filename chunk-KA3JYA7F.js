...
// node_modules/.pnpm/mermaid@11.16.1/node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs
...
var config = __spreadProps(__spreadValues({}, config_schema_default), {
  ...
  railroad: __spreadProps(__spreadValues({}, config_schema_default.railroad), {
  ...
  cynefin: __spreadValues({}, config_schema_default.cynefin)
});
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text2, config2) => {
  ...
  if (true) {
    const { default: katex } = await import("./katex-QX4HSULX.js");
