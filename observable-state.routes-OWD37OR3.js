...
var routes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./observable-state.component-FOJYEUTF.js").then((m) => m.ObservableStateComponent)
  }, false ? { \u0275entryName: "app/observable-state/observable-sate/observable-state.component.ts" } : {}),
  __spreadValues({
    path: "hook",
    loadComponent: () => import("./lifeycle-hooks-sample.component-UDGPB6RZ.js").then((m) => m.LifeycleHooksSampleComponent)
