...
} from "./chunk-ZDK3HJMF.js";
import {
  isGuardsCheckEnd,
  updateRouteInfo
} from "./chunk-DBMMOQHO.js";
import {
  toSignal
} from "./chunk-GRUZ5NAR.js";
import {
  ActivatedRoute,
  Router,
  RouterOutlet,
...
} from "./chunk-5FLPQWEU.js";
import "./chunk-ZJWOAI6A.js";
import {
  HttpClient,
  provideHttpClient,
  withInterceptors
} from "./chunk-WFNGJKE2.js";
...
// node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.2.0/node_modules/@fortawesome/free-solid-svg-icons/faPause.js
var require_faPause = __commonJS({
  "node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.2.0/node_modules/@fortawesome/free-solid-svg-icons/faPause.js"(exports) {
    "use strict";
...
// node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.2.0/node_modules/@fortawesome/free-solid-svg-icons/faPlay.js
var require_faPlay = __commonJS({
  "node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.2.0/node_modules/@fortawesome/free-solid-svg-icons/faPlay.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var prefix = "fas";
    var iconName = "play";
...
var routes = [
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./blogs.component-CUJRWITH.js").then((m2) => m2.BlogsComponent)
  ...
  __spreadValues({
    path: "mqtt",
    loadChildren: () => import("./mqtt.routes-LZRY5NZ4.js").then((m2) => m2.routes)
  }, false ? { \u0275entryName: "app/mqtt/mqtt.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./demo.component-5IFT7JCV.js").then((m2) => m2.DemoComponent),
    children: [
      {
        path: "filterSamp",
        data: {
        ...
        loadComponent: () => import("./filter-sample.component-XM2DA6K4.js").then((m2) => m2.FilterSampleComponent)
      },
      {
        path: "modalSamp",
        loadComponent: () => import("./modal-demo.component-PJZSTMAR.js").then((m2) => m2.ModalDemoComponent)
      },
      {
        path: "mixinSamp",
        loadComponent: () => import("./mixins.component-4RDNTKLE.js").then((m2) => m2.MixinsComponent)
      },
      {
        path: "htmlLoad",
        loadComponent: () => import("./htmlload.component-7YMX2VCF.js").then((m2) => m2.HtmlloadComponent)
      },
      // {
      //   path: 'popup',
      //   outlet: 'popup',
      ...
      // },
      {
        ...
        loadComponent: () => import("./required-attributes.component-NLSCDFWG.js").then((m2) => m2.RequiredAttributesComponent)
      },
      // {
      //   path: 'viewModel',
      ...
      {
        path: "complexAPI",
        loadComponent: () => import("./apisample.component-JFBFDPVY.js").then((m2) => m2.APISampleComponent)
      },
      {
        path: "pokeAPI",
        loadComponent: () => import("./pokemain.component-YBS65OAG.js").then((m2) => m2.PokeMainComponent)
      },
      {
        path: "observableState",
        loadChildren: () => import("./observable-state.routes-RLTKBOBG.js").then((m2) => m2.routes)
      },
      {
        path: "DirectiveSamp",
        loadComponent: () => import("./directives-sample.component-XZYSGOL5.js").then((m2) => m2.DirectivesSampleComponent)
      },
      {
        path: "svg",
        loadComponent: () => import("./svg-calender.component-QTX5GXFK.js").then((m2) => m2.SvgCalenderComponent)
      },
      {
        path: "testOb",
        loadChildren: () => import("./test.routes-F5APN72J.js").then((module) => module.routes)
      },
      {
        path: "home",
      ...
      {
        path: "dynhtml",
        loadComponent: () => import("./dynamichtml.component-ZBYTFT5Y.js").then((m2) => m2.DynamicHtmlComponent)
      },
      {
        path: "snow",
        loadComponent: () => import("./snow.component-TEUDMK3X.js").then((m2) => m2.SnowComponent)
      },
      {
        path: "tumblr",
        loadComponent: () => import("./tumblr.component-4VFSY3T4.js").then((m2) => m2.TumblrComponent)
      },
      {
        path: "bigData",
        loadComponent: () => import("./big-data.component-B4OVNRL5.js").then((m2) => m2.BigDataComponent)
      },
      {
        path: "svgTest",
        loadComponent: () => import("./svg-test.component-YVFYFXFC.js").then((m2) => m2.SvgTestComponent)
      },
      {
        path: "pannel",
        loadComponent: () => import("./pannel-stuff.component-UNVRZJX2.js").then((m2) => m2.PannelStuffComponent)
      },
      {
        path: "clock",
        loadComponent: () => import("./analog-clock.component-B2LGMUE4.js").then((m2) => m2.AnalogClockComponent)
      },
      {
        path: "gridThings",
        loadComponent: () => import("./gridthings.component-2C4WS4PV.js").then((m2) => m2.GridthingsComponent)
      },
      {
        path: "bintree",
        loadComponent: () => import("./bintree.component-BIHEE4XI.js").then((m2) => m2.BintreeComponent)
      },
      {
        path: "localState",
        loadChildren: () => import("./local-state.routes-5NNECQ6U.js").then((m2) => m2.routes)
      },
      {
        path: "lazyComponents",
        loadComponent: () => import("./lazy-component.component-BWYRPKIJ.js").then((m2) => m2.LazyComponentComponent)
      },
      {
        path: "svgTimer",
        loadComponent: () => import("./svg-timer.component-SEBLHA2B.js").then((m2) => m2.SvgTimerComponent)
      },
      {
        path: "svgClock",
        loadComponent: () => import("./svg-clock.component-FHUDXJNF.js").then((m2) => m2.SvgClockComponent)
      },
      {
        path: "dynForm",
        loadComponent: () => import("./dyn-form.component-PBQJNKWV.js").then((m2) => m2.DynFormComponent)
      },
      {
        path: "rxjsTest",
        loadComponent: () => import("./rxjstest.component-4QYRUK2I.js").then((m2) => m2.RxjstestComponent)
      },
      {
        path: "unsubSample",
        loadComponent: () => import("./unsub-sample.component-7XYDFXOS.js").then((m2) => m2.UnsubSampleComponent)
      },
      {
        path: "unsubSample/:id",
        loadComponent: () => import("./unsub-sample.component-7XYDFXOS.js").then((m2) => m2.UnsubSampleComponent)
      },
      { path: "rvt", loadChildren: () => import("./routes-XTXBOMVQ.js") },
      {
        path: "gridCalender",
        loadComponent: () => import("./grid-calender.component-4SAIGFSW.js").then((m2) => m2.GridCalenderComponent)
      },
      {
        path: "summary",
        loadComponent: () => import("./html-summary.component-BC6VM6DW.js").then((m2) => m2.HtmlSummaryComponent)
      },
      {
        path: "resizePanel",
        loadComponent: () => import("./resizable-panels.component-BGFUIOWS.js").then((m2) => m2.ResizablePanelsComponent)
      },
      {
        path: "signalsInForm",
        loadComponent: () => import("./signals-form.component-QRPNV2VA.js").then((m2) => m2.SignalsFormsComponent)
      },
      {
        path: "card",
        loadComponent: () => import("./card.component-UJ6FCFYL.js").then((m2) => m2.CardComponent)
      },
      {
        path: "cells",
        loadComponent: () => import("./cells.component-V4UDROV2.js").then((m2) => m2.CellsComponent)
      },
      {
        path: "cellsRaw",
        loadComponent: () => import("./cell-raw.component-WEUWTYOV.js").then((m2) => m2.CellRawComponent)
      },
      {
        path: "routeList",
        loadComponent: () => import("./route-list.component-X73AACGT.js").then((m2) => m2.RouteListComponent)
      },
      {
        path: "formErrors",
        loadComponent: () => import("./form-error.component-S3LZCFAU.js")
      },
      {
        path: "dialog",
        loadComponent: () => import("./dialog.component-YPDE57BU.js")
      },
      {
        path: "signalInputMusings",
        loadComponent: () => import("./signal-input-musings.component-NVHR36HM.js").then((m2) => m2.SignalInputMusingsComponent)
      },
      {
        path: "signalPlay",
        loadComponent: () => import("./signal-play.component-ZM63HP6G.js")
      },
      // {
      //   path: 'signalError',
      ...
      {
        path: "eventedOutputs",
        loadComponent: () => import("./evented-outputs.component-7BOJR5Z6.js").then((m2) => m2.EventedOutputsComponent)
      },
      {
        path: "indexDb",
        loadComponent: () => import("./indexdb.component-N37OVYH4.js").then((m2) => m2.IndexdbComponent),
        title: "IndexDb sample"
      },
      {
        path: "acnhorPosition",
        loadComponent: () => import("./anchor-pos.component-EGXKOOHS.js").then((m2) => m2.AnchorPosComponent),
        title: "Anchor Position demo"
      },
      {
        path: "outOfOrder",
        loadComponent: () => import("./out-of-order.component-IDXLKLZT.js").then((m2) => m2.OutOfOrderComponent)
      },
      {
        path: "stepper",
        loadComponent: () => import("./stepper.component-3DGL3VI2.js").then((m2) => m2.StepperComponent)
      },
      {
        path: "iconSprite",
        loadComponent: () => import("./icon-sprite.component-AEVZT36L.js").then((m2) => m2.IconSpriteComponent)
      },
      {
        path: "reusableDialog",
        loadComponent: () => import("./reusable-dialog.component-NERU6CPQ.js").then((m2) => m2.ReusableDialogComponent)
      },
      {
        path: "tableHover",
        loadComponent: () => import("./table-hover.component-WKLMNEUC.js").then((m2) => m2.TableHoverComponent)
      },
      {
        path: "signalDebounce",
        loadComponent: () => import("./signal-debounce.component-RBWXZPJC.js").then((m2) => m2.SignalDebounce)
      },
      {
        path: "crudStuff",
        loadComponent: () => import("./crud-stuff.component-3QWTNPMG.js").then((m2) => m2.CrudStuffComponent)
      },
      {
        path: "customNativeForm",
        loadComponent: () => import("./custom-native-form.component-RSJMVEFU.js").then((m2) => m2.CustomNativeFormComponent)
      },
      {
        path: "inputHostExperiment",
        loadComponent: () => import("./input-host-experiment.component-KGMJYMOS.js").then((m2) => m2.InputHostExperimentComponent)
      },
      {
        path: "meteredView",
        loadComponent: () => import("./metered-view.component-GXT5D4JM.js").then((m2) => m2.MeteredViewComponent)
      },
      {
        path: "signalForms",
        loadComponent: () => import("./signal-forms-experiment.component-4OOMLGCT.js").then((m2) => m2.SignalFormsExperimentComponent)
      },
      {
        path: "signalForms/tree",
        loadComponent: () => import("./signal-tree.component-J6KMHHDY.js").then((m2) => m2.SignalTreeComponent)
      },
      {
        path: "signalForms/dynamic",
        loadComponent: () => import("./dynamic.component-M6ZJEQJ5.js").then((m2) => m2.DynamicComponent)
      },
      {
        path: "toh",
        loadComponent: () => import("./toh.component-4N7RH5BM.js").then((m2) => m2.TohComponent)
      },
      {
        path: "toh/cdk",
        loadComponent: () => import("./toh-cdk.component-46HDHRDI.js").then((m2) => m2.TohCdkComponent)
      },
      {
        path: "vt",
        loadComponent: () => import("./view-transitions.component-VWGLL7P4.js").then((m2) => m2.ViewTransitionsComponent)
      },
      {
        path: "inMem",
        loadComponent: () => import("./in-mem-sample.component-OR7KYEHB.js").then((m2) => m2.InMemSampleComponent)
      },
      {
        path: "dynSignalForm",
        loadComponent: () => import("./dynsignal-form.component-MKBI2VXN.js").then((m2) => m2.DynsignalFormComponent)
      },
      {
        path: "dyn-route",
        loadChildren: () => import("./dyn-routes.routes-XOZWF7WA.js").then((m2) => m2.dynRoutes)
      },
      {
        path: "timer",
        loadComponent: () => import("./timer.component-OF65UGM6.js").then((m2) => m2.TimerComponent)
      },
      {
        path: "temporal",
        loadComponent: () => import("./temporal.component-YO4D3OKF.js").then((m2) => m2.TemporalComponent)
      },
      {
        path: "gridPlay",
        loadComponent: () => import("./grid-play.component-FFY46KJU.js").then((m2) => m2.GridPlayComponent)
      },
      {
        path: "caddy",
        loadComponent: () => import("./caddy.component-6UWZDJ7U.js").then((m2) => m2.CaddyComponent)
      },
      {
        path: "boxes",
        loadComponent: () => import("./boxes.component-KE34R2R5.js").then((m2) => m2.BoxesComponent)
      },
      {
        path: "gamepad",
        loadComponent: () => import("./gamepad.component-W3BKMAQD.js").then((m2) => m2.GamepadComponent)
      },
