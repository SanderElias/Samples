...
var possibleComponents = {
  foo: () => import("./foo.component-4EAPDYUS.js").then((m) => m.FooComponent),
  bar: () => import("./bar.component-OZJOLQHL.js").then((m) => m.BarComponent),
  baz: () => import("./baz.component-K74O5JX7.js").then((m) => m.BazComponent)
};
var dynRoutes = [
  {
    path: "",
