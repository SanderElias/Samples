...
function loadMermaid() {
  if (!mermaidLoader) {
    mermaidLoader = import("./mermaid.core-3OI7ON24.js").then(({ default: mermaid }) => mermaid);
  }
...
async function parser(content) {
  const { Marked } = await import("./marked.esm-X7RPA7YM.js");
  let marked = new Marked();
  try {
    const { default: hljs } = await import("./core-3IB4JUFR.js");
    const { default: typescript } = await import("./typescript-IDYUBRFJ.js");
    const { default: css } = await import("./css-3KQQ576I.js");
    const { default: html } = await import("./xml-O57XUX27.js");
    const { default: javascript } = await import("./javascript-BYAFRTOF.js");
    const { default: plaintext } = await import("./plaintext-74YRK55I.js");
