...
var routes = [
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./blogs.component-FWBYIDLL.js").then((m2) => m2.BlogsComponent)
  ...
  __spreadValues({
    path: "mqtt",
    loadChildren: () => import("./mqtt.routes-KDMTLCNV.js").then((m2) => m2.routes)
  }, false ? { \u0275entryName: "app/mqtt/mqtt.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./demo.component-N3MSXJMC.js").then((m2) => m2.DemoComponent),
    children: [
      {
        path: "filterSamp",
        data: {
        ...
        loadComponent: () => import("./filter-sample.component-W2STKSEH.js").then((m2) => m2.FilterSampleComponent)
      },
      {
        path: "modalSamp",
        loadComponent: () => import("./modal-demo.component-REIYS33V.js").then((m2) => m2.ModalDemoComponent)
      },
      {
        path: "mixinSamp",
        loadComponent: () => import("./mixins.component-H6CCCN5K.js").then((m2) => m2.MixinsComponent)
      },
      {
        path: "htmlLoad",
        loadComponent: () => import("./htmlload.component-ZTTRG56O.js").then((m2) => m2.HtmlloadComponent)
      },
      // {
      //   path: 'popup',
      //   outlet: 'popup',
      ...
      // },
      {
        ...
        loadComponent: () => import("./required-attributes.component-AGXYVYZP.js").then((m2) => m2.RequiredAttributesComponent)
      },
      // {
      //   path: 'viewModel',
      ...
      {
        path: "complexAPI",
        loadComponent: () => import("./apisample.component-6XXQOXH2.js").then((m2) => m2.APISampleComponent)
      },
      {
        path: "pokeAPI",
        loadComponent: () => import("./pokemain.component-2W3RQ42Z.js").then((m2) => m2.PokeMainComponent)
      },
      {
        path: "observableState",
        loadChildren: () => import("./observable-state.routes-KGRUAJFR.js").then((m2) => m2.routes)
      },
      {
        path: "DirectiveSamp",
        loadComponent: () => import("./directives-sample.component-QCDE3MF2.js").then((m2) => m2.DirectivesSampleComponent)
      },
      {
        path: "svg",
        loadComponent: () => import("./svg-calender.component-DKTDHTU7.js").then((m2) => m2.SvgCalenderComponent)
      },
      {
        path: "testOb",
        loadChildren: () => import("./test.routes-OFUF3JAC.js").then((module) => module.routes)
      },
      {
        path: "home",
      ...
      {
        path: "dynhtml",
        loadComponent: () => import("./dynamichtml.component-WWU2QA6S.js").then((m2) => m2.DynamicHtmlComponent)
      },
      {
        path: "snow",
        loadComponent: () => import("./snow.component-NGO6XI4I.js").then((m2) => m2.SnowComponent)
      },
      {
        path: "tumblr",
        loadComponent: () => import("./tumblr.component-A2TSSK62.js").then((m2) => m2.TumblrComponent)
      },
      {
        path: "bigData",
        loadComponent: () => import("./big-data.component-D7OZCWHX.js").then((m2) => m2.BigDataComponent)
      },
      {
        path: "svgTest",
        loadComponent: () => import("./svg-test.component-6LXYEX5J.js").then((m2) => m2.SvgTestComponent)
      },
      {
        path: "pannel",
        loadComponent: () => import("./pannel-stuff.component-Y6IG4B7M.js").then((m2) => m2.PannelStuffComponent)
      },
      {
        path: "clock",
        loadComponent: () => import("./analog-clock.component-PKT4FFBR.js").then((m2) => m2.AnalogClockComponent)
      },
      {
        path: "gridThings",
        loadComponent: () => import("./gridthings.component-WOZCA34L.js").then((m2) => m2.GridthingsComponent)
      },
      {
        path: "bintree",
        loadComponent: () => import("./bintree.component-CSSZ263Y.js").then((m2) => m2.BintreeComponent)
      },
      {
        path: "localState",
        loadChildren: () => import("./local-state.routes-OR7JUBYC.js").then((m2) => m2.routes)
      },
      {
        path: "lazyComponents",
        loadComponent: () => import("./lazy-component.component-VLTLLW25.js").then((m2) => m2.LazyComponentComponent)
      },
      {
        path: "svgTimer",
        loadComponent: () => import("./svg-timer.component-PH6MRUCX.js").then((m2) => m2.SvgTimerComponent)
      },
      {
        path: "svgClock",
        loadComponent: () => import("./svg-clock.component-5RWECXI6.js").then((m2) => m2.SvgClockComponent)
      },
      {
        path: "dynForm",
        loadComponent: () => import("./dyn-form.component-I72N7U2I.js").then((m2) => m2.DynFormComponent)
      },
      {
        path: "rxjsTest",
        loadComponent: () => import("./rxjstest.component-SPAQG5O3.js").then((m2) => m2.RxjstestComponent)
      },
      {
        path: "unsubSample",
        loadComponent: () => import("./unsub-sample.component-HVDL6Q5K.js").then((m2) => m2.UnsubSampleComponent)
      },
      {
        path: "unsubSample/:id",
        loadComponent: () => import("./unsub-sample.component-HVDL6Q5K.js").then((m2) => m2.UnsubSampleComponent)
      },
      { path: "rvt", loadChildren: () => import("./routes-YJ3GE2NQ.js") },
      {
        path: "gridCalender",
        loadComponent: () => import("./grid-calender.component-BBL5T3U6.js").then((m2) => m2.GridCalenderComponent)
      },
      {
        path: "summary",
        loadComponent: () => import("./html-summary.component-R5MIUVJB.js").then((m2) => m2.HtmlSummaryComponent)
      },
      {
        path: "resizePanel",
        loadComponent: () => import("./resizable-panels.component-SCRWEBLC.js").then((m2) => m2.ResizablePanelsComponent)
      },
      {
        path: "signalsInForm",
        loadComponent: () => import("./signals-form.component-FRC2RKTG.js").then((m2) => m2.SignalsFormsComponent)
      },
      {
        path: "card",
        loadComponent: () => import("./card.component-3FIMLZQ4.js").then((m2) => m2.CardComponent)
      },
      {
        path: "cells",
        loadComponent: () => import("./cells.component-U4A7MFGX.js").then((m2) => m2.CellsComponent)
      },
      {
        path: "cellsRaw",
        loadComponent: () => import("./cell-raw.component-3M7JSRE5.js").then((m2) => m2.CellRawComponent)
      },
      {
        path: "routeList",
        loadComponent: () => import("./route-list.component-R3X2NMRO.js").then((m2) => m2.RouteListComponent)
      },
      {
        path: "formErrors",
        loadComponent: () => import("./form-error.component-JYEUMMJU.js")
      },
      {
        path: "dialog",
        loadComponent: () => import("./dialog.component-C2SCFQF6.js")
      },
      {
        path: "signalInputMusings",
        loadComponent: () => import("./signal-input-musings.component-SKIS4T3Y.js").then((m2) => m2.SignalInputMusingsComponent)
      },
      {
        path: "signalPlay",
        loadComponent: () => import("./signal-play.component-K6TOCFGT.js")
      },
      // {
      //   path: 'signalError',
      ...
      {
        path: "eventedOutputs",
        loadComponent: () => import("./evented-outputs.component-V73VEYS4.js").then((m2) => m2.EventedOutputsComponent)
      },
      {
        path: "indexDb",
        loadComponent: () => import("./indexdb.component-NM7TYYO2.js").then((m2) => m2.IndexdbComponent),
        title: "IndexDb sample"
      },
      {
        path: "acnhorPosition",
        loadComponent: () => import("./anchor-pos.component-L2JOBPJ3.js").then((m2) => m2.AnchorPosComponent),
        title: "Anchor Position demo"
      },
      {
        path: "outOfOrder",
        loadComponent: () => import("./out-of-order.component-VJXGZE52.js").then((m2) => m2.OutOfOrderComponent)
      },
      {
        path: "stepper",
        loadComponent: () => import("./stepper.component-G3YCV57E.js").then((m2) => m2.StepperComponent)
      },
      {
        path: "iconSprite",
        loadComponent: () => import("./icon-sprite.component-V3IJCXK6.js").then((m2) => m2.IconSpriteComponent)
      },
      {
        path: "reusableDialog",
        loadComponent: () => import("./reusable-dialog.component-6ZHSOF2G.js").then((m2) => m2.ReusableDialogComponent)
      },
      {
        path: "tableHover",
        loadComponent: () => import("./table-hover.component-ZKVGWBZQ.js").then((m2) => m2.TableHoverComponent)
      },
      {
        path: "signalDebounce",
        loadComponent: () => import("./signal-debounce.component-5OYTZJ2Z.js").then((m2) => m2.SignalDebounce)
      },
      {
        path: "crudStuff",
        loadComponent: () => import("./crud-stuff.component-FERM7TV2.js").then((m2) => m2.CrudStuffComponent)
      },
      {
        path: "customNativeForm",
        loadComponent: () => import("./custom-native-form.component-UBHIPWGJ.js").then((m2) => m2.CustomNativeFormComponent)
      },
      {
        path: "inputHostExperiment",
        loadComponent: () => import("./input-host-experiment.component-ZV6YPKWJ.js").then((m2) => m2.InputHostExperimentComponent)
      },
      {
        path: "meteredView",
        loadComponent: () => import("./metered-view.component-MDY44XKA.js").then((m2) => m2.MeteredViewComponent)
      },
      {
        path: "signalForms",
        loadComponent: () => import("./signal-forms-experiment.component-QWCZAPKY.js").then((m2) => m2.SignalFormsExperimentComponent)
      },
      {
        path: "signalForms/tree",
        loadComponent: () => import("./signal-tree.component-FR7YPASR.js").then((m2) => m2.SignalTreeComponent)
      },
      {
        path: "signalForms/dynamic",
        loadComponent: () => import("./dynamic.component-3VQNBN67.js").then((m2) => m2.DynamicComponent)
      },
      {
        path: "toh",
        loadComponent: () => import("./toh.component-VHVCIRTF.js").then((m2) => m2.TohComponent)
      },
      {
        path: "toh/cdk",
        loadComponent: () => import("./toh-cdk.component-USYBQHGT.js").then((m2) => m2.TohCdkComponent)
      },
      {
        path: "vt",
        loadComponent: () => import("./view-transitions.component-7TEUWUH2.js").then((m2) => m2.ViewTransitionsComponent)
      },
      {
        path: "inMem",
        loadComponent: () => import("./in-mem-sample.component-AW7IEXZ4.js").then((m2) => m2.InMemSampleComponent)
      },
      {
        path: "dynSignalForm",
        loadComponent: () => import("./dynsignal-form.component-JX4MPQKM.js").then((m2) => m2.DynsignalFormComponent)
      },
      {
        path: "dyn-route",
        loadChildren: () => import("./dyn-routes.routes-YFBAC3IE.js").then((m2) => m2.dynRoutes)
      },
      {
        path: "timer",
        loadComponent: () => import("./timer.component-LJ5EACOT.js").then((m2) => m2.TimerComponent)
      },
      {
        path: "temporal",
        loadComponent: () => import("./temporal.component-4POV3COT.js").then((m2) => m2.TemporalComponent)
      },
      {
        path: "gridPlay",
        loadComponent: () => import("./grid-play.component-BYVDAKCV.js").then((m2) => m2.GridPlayComponent)
      },
      {
        path: "caddy",
        loadComponent: () => import("./caddy.component-W4PNWQ2V.js").then((m2) => m2.CaddyComponent)
      },
      {
        path: "boxes",
        loadComponent: () => import("./boxes.component-KTYSZXXH.js").then((m2) => m2.BoxesComponent)
      },
