import {
  Bloglist
} from "./chunk-Y3FEBDMH.js";
import "./chunk-W5YSDQJX.js";
import {
  DomSanitizer,
  Title
...
var BlogsComponent_Defer_1_DepsFn = () => [
  /* @ts-ignore */
  import("./blog-list.component-HTW5L7VK.js").then((m) => m.BlogListComponent)
];
  ...
  constructor() {
    ...
    this.testblog = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "testblog" } : (
      ...
      loader: async ({ params }) => {
        ...
        if (content) {
          const { parser } = await import("./parser-QWGFI4SS.js");
