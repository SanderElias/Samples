import{l as B}from"./chunk-YHXAY3DU.js";import{n as O,o as H,q as L}from"./chunk-JUPB3CFF.js";import{Fb as b,Gb as q,Hb as J,Ib as E,Qa as P,Ua as F,Wa as y,ab as k,ba as u,bb as n,cb as o,db as D,ia as h,ja as g,ka as C,lb as S,nb as N,o as I,ob as T,rb as r,y as R}from"./chunk-FSDOJMUS.js";import"./chunk-G5KKTNWD.js";var A=["*"],p=class{constructor(e){this.elmRef=e,this.shadowRoot=this.elmRef.nativeElement?.shadowRoot}},d=p;(()=>{p.\u0275fac=function(t){return new(t||p)(y(P))}})(),(()=>{p.\u0275cmp=h({type:p,selectors:[["app-pannel"]],ngContentSelectors:A,decls:5,vars:0,consts:[[1,"pannel"]],template:function(t,i){t&1&&(N(),n(0,"div",0),D(1,"header"),n(2,"main"),T(3),o(),D(4,"footer"),o())},styles:[`
  .pannel {
    display:grid;
