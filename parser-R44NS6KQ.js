...
function loadMermaid() {
  if (!mermaidLoader) {
    mermaidLoader = import("./mermaid.core-LBKPEF4G.js").then(({ default: mermaid }) => mermaid);
  }
...
async function parser(content) {
  const { Marked } = await import("./marked.esm-FQ6IEGHW.js");
  let marked = new Marked();
  try {
    const { default: hljs } = await import("./core-J3VNM4OC.js");
    const { default: typescript } = await import("./typescript-GWKNSNER.js");
    const { default: css } = await import("./css-24KGBQSA.js");
    const { default: html } = await import("./xml-WWOM4ZD4.js");
    const { default: javascript } = await import("./javascript-ZPWEA4A2.js");
    const { default: plaintext } = await import("./plaintext-EAAFEBK7.js");
