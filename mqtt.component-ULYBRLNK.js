...
} from "./chunk-SMUTWXEI.js";
import {
  GaugeComponent,
  StackedPerComponent
} from "./chunk-I6KLLWYY.js";
import {
  FormField,
  FormRoot,
  form
} from "./chunk-6WQTHTKU.js";
import {
  persistentSignal
...
import {
  ...
  ZigbeeService,
  undefinedWhenEmpty
} from "./chunk-6V3JPTHB.js";
import "./chunk-H6SNLH66.js";
import "./chunk-RI77EIII.js";
import "./chunk-O2ACNGJC.js";
import "./chunk-V5IPUR26.js";
import {
  toObservable,
  toSignal
} from "./chunk-JNPCVYL6.js";
import "./chunk-SB6SG6LP.js";
import "./chunk-3ISA7L5J.js";
import "./chunk-XUVHIZKL.js";
import "./chunk-4UH6P2KG.js";
import {
  debouncedComputed,
  deepEqual,
  proxySignal
...
var PowerMeterDialogComponent = class _PowerMeterDialogComponent {
  constructor() {
    this.dialogRef = viewChild.required(
      "dlg",
      ...ngDevMode ? [{ debugName: "dialogRef" }] : (
        /* istanbul ignore next */
        []
      )
    );
...
function PowerMeterComponent_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r0.deviceStatus()?.voltage, " V");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r0.deviceStatus()?.current, " A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r0.deviceStatus()?.energy, " kWh");
  }
}
