...
var GridthingsComponent = class _GridthingsComponent {
  ...
  static {
    ...
    }, dependencies: [CellComponent], styles: ['\n[_ngcontent-%COMP%]:root {\n  --%NS%cols: 10;\n  --%NS%rows: 10;\n}\n[_nghost-%COMP%] {\n  --%NS%cols: 10;\n  position: relative;\n  display: grid;\n  width: 100%;\n  height: 100%;\n  border: 1px solid white;\n  grid-template-columns: repeat(var(--%NS%cols), calc(100% / var(--%NS%cols)));\n  grid-template-rows: repeat(var(--%NS%rows), calc(100% / var(--%NS%rows)));\n  background:\n    linear-gradient(\n      90deg,\n      transparent calc(100% - 1px),\n      white 1px);\n  background-size: calc(100% / var(--%NS%cols));\n}\n[_nghost-%COMP%]::after {\n  --%NS%rows: 10;\n  content: " ";\n  position: absolute;\n  display: block;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  left: 0;\n  background-image: linear-gradient(transparent 50%, #ffffff30 50%);\n  background-size: 100% calc(100% / (var(--%NS%rows) / 2));\n}'] });
  }
};
(() => {
