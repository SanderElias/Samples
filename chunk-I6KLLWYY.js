...
var StackedPerComponent = class _StackedPerComponent {
  ...
  static {
    ...
    }, styles: ["\n[_nghost-%COMP%] {\n  display: flex;\n  margin-block-start: 1rem;\n  --%NS%metered-color-0: #5f7331;\n  --%NS%metered-color-1: #5f4690;\n  --%NS%metered-color-2: #1d6996;\n  --%NS%metered-color-3: #38a6a5;\n  --%NS%metered-color-4: #0f8554;\n  --%NS%metered-color-5: #73af48;\n  --%NS%metered-color-6: #edad08;\n  --%NS%metered-color-7: #e17c05;\n  --%NS%metered-color-8: #cc503e;\n  --%NS%metered-color-9: #94346e;\n  --%NS%metered-color-10: #6f2c91;\n  border: #79c1c9 solid 1px;\n}\n[_nghost-%COMP%]   div[_ngcontent-%COMP%] {\n  padding: var(--%NS%size-2);\n  writing-mode: vertical-lr;\n  overflow: hidden;\n}"] });
  }
};
(() => {
...
var GaugeComponent = class _GaugeComponent {
  ...
  static {
    ...
    }, styles: ["\n[_nghost-%COMP%] {\n  --%NS%_inline-size: 100px;\n  --%NS%_block-size: 100px;\n  display: inline-block;\n  position: relative;\n  inline-size: var(--%NS%_inline-size);\n  block-size: var(--%NS%_block-size);\n}\nsvg.myGauge[_ngcontent-%COMP%] {\n  inline-size: var(--%NS%_inline-size);\n  block-size: var(--%NS%_block-size);\n  --%NS%_meter-backgroundColor: var(--%NS%meter-backgroundColor, var(--%NS%surface-3));\n  background-repeat: no-repeat;\n  background-position: center;\n  background:\n    conic-gradient(\n      from 202deg at center,\n      #00c853 0deg,\n      #ff0000 316deg,\n      transparent 316deg);\n}\n.text[_ngcontent-%COMP%] {\n  position: absolute;\n  inset: 0;\n  display: grid;\n  place-items: center;\n  font-size: 0.8rem;\n  color: white;\n  text-align: center;\n  pointer-events: none;\n}"] });
  }
};
(() => {
