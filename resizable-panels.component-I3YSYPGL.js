...
var ResizablePanelComponent = class _ResizablePanelComponent {
  ...
  static {
    ...
    }, styles: ["\n[_nghost-%COMP%] {\n  display: inline-block;\n  --%NS%_panel-width: var(--%NS%panel-width, 300px);\n  --%NS%_panel-height: var(--%NS%panel-height, 300px);\n  margin: calc(var(--%NS%panel-gap) / 2);\n  width: var(--%NS%_panel-width);\n  height: var(--%NS%_panel-height);\n  min-height: 1.5rem;\n  min-width: 4rem;\n  resize: both;\n  overflow: auto;\n  border: 1px solid white;\n}"] });
  }
};
(() => {
