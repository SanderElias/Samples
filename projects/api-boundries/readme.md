...
The first block of code, is the code i need to gather all the data I need for display upfront. The second one is when I use simple component APIs. **_This code is completely gone. It is not scattered over the code base. it is GONE!_**
