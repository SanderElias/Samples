import{k as R,l as j}from"./chunk-4XL46QIM.js";import{Hb as d,Jb as y,Kb as B,Lb as I,Mb as g,Ta as v,Xa as S,_a as c,fb as b,gb as i,ha as p,hb as r,ib as u,ja as f,o as x,pb as h,rb as E,sb as C,vb as s,y as w}from"./chunk-ZWPQDWQV.js";import"./chunk-G5KKTNWD.js";var P=["*"],m=(()=>{let e=class{constructor(t){this.elmRef=t,this.shadowRoot=this.elmRef.nativeElement?.shadowRoot}},o=e;return(()=>{e.\u0275fac=function(n){return new(n||e)(c(v))}})(),(()=>{e.\u0275cmp=p({type:e,selectors:[["app-pannel"]],standalone:!0,features:[d],ngContentSelectors:P,decls:5,vars:0,consts:[[1,"pannel"]],template:function(n,a){n&1&&(E(),i(0,"div",0),u(1,"header"),i(2,"main"),C(3),r(),u(4,"footer"),r())},styles:[`
  .pannel {
    display:grid;
