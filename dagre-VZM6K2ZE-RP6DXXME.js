...
// node_modules/.pnpm/mermaid@11.16.1/node_modules/mermaid/dist/chunks/mermaid.core/dagre-VZM6K2ZE.mjs
...
var getEdgesToRender = /* @__PURE__ */ __name((graph, yOffset = 0, { mergeSelfLoops = true } = {}) => {
  ...
  selfLoopEdgeGroups.forEach((segments) => {
    ...
    const mergedEdge = __spreadProps(__spreadValues(__spreadValues({}, middleSegment.edge), originalEdge), {
      id: originalEdge.id,
      points,
