import{l as B}from"./chunk-ELRT2GQ7.js";import{n as O,o as H,q as L}from"./chunk-WA577VHR.js";import{$a as k,Eb as b,Fb as q,Gb as J,Hb as E,Oa as P,Ta as F,Va as y,aa as u,ab as n,bb as o,cb as D,ha as h,ia as g,ja as C,kb as S,mb as N,nb as T,o as I,qb as r,y as R}from"./chunk-MHRY5PTC.js";import"./chunk-G5KKTNWD.js";var A=["*"],p=class{constructor(e){this.elmRef=e,this.shadowRoot=this.elmRef.nativeElement?.shadowRoot}},d=p;(()=>{p.\u0275fac=function(t){return new(t||p)(y(P))}})(),(()=>{p.\u0275cmp=h({type:p,selectors:[["app-pannel"]],ngContentSelectors:A,decls:5,vars:0,consts:[[1,"pannel"]],template:function(t,i){t&1&&(N(),n(0,"div",0),D(1,"header"),n(2,"main"),T(3),o(),D(4,"footer"),o())},styles:[`
  .pannel {
    display:grid;
