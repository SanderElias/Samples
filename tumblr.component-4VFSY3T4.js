...
function TumblrComponent_For_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275domProperty("src", i_r4.images == null ? null : i_r4.images[0] == null ? null : i_r4.images[0].link, \u0275\u0275sanitizeUrl);
  }
}
...
var TumblrComponent = class _TumblrComponent {
  ...
  ngOnInit() {
    ...
    if (elm) {
      ...
      from(import("./main.module-CAM5CYJZ.js")).pipe(
