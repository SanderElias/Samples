import{i as P,j as B}from"./chunk-GOJFU6NU.js";import{$b as D,A as v,Aa as x,Ca as m,Fb as h,Hb as C,Ib as b,Ob as a,Wa as w,Xa as p,Xb as c,Zb as y,_b as E,ha as l,ja as f,nb as S,q as g,wb as o,xb as i,yb as u}from"./chunk-XM75YRED.js";import"./chunk-KAT7YFEL.js";var R=["*"],d=(()=>{class e{constructor(t){this.elmRef=t,this.shadowRoot=this.elmRef.nativeElement?.shadowRoot}static{this.\u0275fac=function(n){return new(n||e)(p(x))}}static{this.\u0275cmp=l({type:e,selectors:[["app-pannel"]],standalone:!0,features:[c],ngContentSelectors:R,decls:5,vars:0,consts:[[1,"pannel"]],template:function(n,r){n&1&&(C(),o(0,"div",0),u(1,"header"),o(2,"main"),b(3),i(),u(4,"footer"),i())},styles:[`
  .pannel {
    display: grid;
