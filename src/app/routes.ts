...
export const routes: Routes = [
  ...
  },
  {
    path: 'mixinSamp',
    loadComponent: () =>
      import('./mixins/mixins/mixins.component').then(m => m.MixinsComponent),
  },
  {
    path: 'htmlLoad',
    loadComponent: () =>
  ...
  // },
  {
    ...
    loadComponent: () =>
      import(
        './required-attributes/required-attributes/required-attributes.component'
      ).then(m => m.RequiredAttributesComponent),
  },
  {
    path: 'viewModel',
    loadChildren: () =>
      import('./view-model/view-model.routes').then(m => m.routes),
  },
  {
    path: 'complexAPI',
    loadComponent: () =>
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./observable-state/observable-state.routes').then(m => m.routes),
  },
  {
    path: 'DirectiveSamp',
    loadComponent: () =>
  ...
  },
  {
    path: 'svgTimer',
    loadComponent: () =>
      import('./svg-timer/svg-timer.component').then(m => m.SvgTimerComponent),
  },
  {
    path: 'svgClock',
    loadComponent: () =>
      import('./svg-clock/svg-clock.component').then(m => m.SvgClockComponent),
  },
  {
    path: 'dynForm',
    loadComponent: () =>
