import{l as B}from"./chunk-XR5XNKCS.js";import{n as O,o as H,q as L}from"./chunk-MQTFCSRU.js";import{Gb as b,Hb as q,Ib as J,Jb as E,Ra as P,Va as F,Xa as y,bb as k,ca as u,cb as n,db as o,eb as D,ja as h,ka as g,la as C,mb as S,ob as N,p as I,pb as T,sb as r,z as R}from"./chunk-MQSRH5NO.js";import"./chunk-G5KKTNWD.js";var A=["*"],p=class{constructor(e){this.elmRef=e,this.shadowRoot=this.elmRef.nativeElement?.shadowRoot}},d=p;(()=>{p.\u0275fac=function(t){return new(t||p)(y(P))}})(),(()=>{p.\u0275cmp=h({type:p,selectors:[["app-pannel"]],ngContentSelectors:A,decls:5,vars:0,consts:[[1,"pannel"]],template:function(t,i){t&1&&(N(),n(0,"div",0),D(1,"header"),n(2,"main"),T(3),o(),D(4,"footer"),o())},styles:[`
  .pannel {
    display:grid;
