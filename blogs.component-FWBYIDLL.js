import {
  Bloglist
} from "./chunk-4TONII3T.js";
import "./chunk-VOWQP44C.js";
import {
  DomSanitizer,
  Title
...
var BlogsComponent_Defer_1_DepsFn = () => [
  /* @ts-ignore */
  import("./blog-list.component-IPJMCL5J.js").then((m) => m.BlogListComponent)
];
  ...
  constructor() {
    ...
    this.testblog = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "testblog" } : (
      ...
      loader: async ({ params }) => {
        ...
        if (content) {
          const { parser } = await import("./parser-Q4AR3AI5.js");
