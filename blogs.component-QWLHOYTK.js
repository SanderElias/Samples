import {
  Bloglist
} from "./chunk-TCUS3HUA.js";
import "./chunk-IHBT2AMQ.js";
import {
  DomSanitizer,
  Title
...
var BlogsComponent_Defer_1_DepsFn = () => [
  /* @ts-ignore */
  import("./blog-list.component-N2XJOKQT.js").then((m) => m.BlogListComponent)
];
  ...
  constructor() {
    ...
    this.testblog = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "testblog" } : (
      ...
      loader: async ({ params }) => {
        ...
        if (content) {
          const { parser } = await import("./parser-3MEMIZYE.js");
