import {
  RelationsService
} from "./chunk-WJJD4ER2.js";
import "./chunk-H6SNLH66.js";
import "./chunk-RI77EIII.js";
import {
  NotifyDialogService
} from "./chunk-O2ACNGJC.js";
import "./chunk-V5IPUR26.js";
import {
  userCard
} from "./chunk-3ISA7L5J.js";
...
async function generateRelation() {
  const fakerModule = import("./dist-ZBTQVWEN.js");
...
var HeaderComponent = class _HeaderComponent {
  constructor() {
    ...
    this.cachingEnabled = this.relationsService.cachingEnabled;
  }
  async addRelation() {
    try {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["crud-header"]], decls: 10, vars: 3, consts: [[3, "click"], ["for", "search"], ["id", "search", "type", "search", "placeholder", "Search...", 3, "input", "value"], [3, "show"]], template: function HeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1("Caching is currently ", ctx.cachingEnabled() ? "enabled" : "disabled", ".");
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src/app/crud-stuff/header/header.component.ts", lineNumber: 39 });
})();
...
var HighLightTDComponent = class _HighLightTDComponent {
  constructor() {
    ...
    this.originalContent = viewChild.required("org", __spreadProps(__spreadValues({}, ngDevMode ? { debugName: "originalContent" } : (
      /* istanbul ignore next */
      {}
    )), { read: ElementRef }));
    this.highLight = () => {
...
var CrudStuffComponent_Defer_22_DepsFn = () => [
  /* @ts-ignore */
  import("./relation-form.component-GFD4H7AM.js").then((m) => m.RelationForm)
];
...
var CrudStuffComponent = class _CrudStuffComponent {
  constructor() {
    ...
    this.dlgRef = viewChild.required(
      "dlg",
      ...ngDevMode ? [{ debugName: "dlgRef" }] : (
        /* istanbul ignore next */
        []
      )
    );
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CrudStuffComponent, { className: "CrudStuffComponent", filePath: "src/app/crud-stuff/crud-stuff.component.ts", lineNumber: 69 });
})();
export {
  CrudStuffComponent
};
