...
// node_modules/.pnpm/mqtt@5.15.2_supports-color@7.2.0/node_modules/mqtt/dist/mqtt.esm.js
...
var $l = j((Si) => {
  ...
  function _T(t) {
    ...
    if (n !== void 0) {
      ...
      return (0, Ub.connect)(__spreadProps(__spreadValues({}, i), { socket: s }));
    }
...
var $b = j((In) => {
  ...
  function Wb(t, e) {
    if (Fb("connecting to an MQTT broker..."), typeof t == "object" && !e && (e = t, t = ""), e = e || {}, t && typeof t == "string") {
      ...
      if (i.port != null && (s.port = Number(i.port)), s.host = i.hostname, s.query = i.query, s.auth = i.auth, s.protocol = i.protocol, s.path = i.path, e = __spreadValues(__spreadValues({}, s), e), !e.protocol && !o) throw new Error("Missing protocol");
