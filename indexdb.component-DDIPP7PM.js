...
:where(html[_ngcontent-%COMP%]) {
  --%NS%font-system-ui:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif;
  --%NS%font-transitional:Charter,Bitstream Charter,Sitka Text,Cambria,serif;
  --%NS%font-old-style:Iowan Old Style,Palatino Linotype,URW Palladio L,P052,serif;
  --%NS%font-humanist:Seravek,Gill Sans Nova,Ubuntu,Calibri,DejaVu Sans,source-sans-pro,sans-serif;
  --%NS%font-geometric-humanist:Avenir,Montserrat,Corbel,URW Gothic,source-sans-pro,sans-serif;
  --%NS%font-classical-humanist:Optima,Candara,Noto Sans,source-sans-pro,sans-serif;
  --%NS%font-neo-grotesque:Inter,Roboto,Helvetica Neue,Arial Nova,Nimbus Sans,Arial,sans-serif;
  --%NS%font-monospace-slab-serif:Nimbus Mono PS,Courier New,monospace;
  --%NS%font-monospace-code:Dank Mono,Operator Mono,Inconsolata,Fira Mono,ui-monospace,SF Mono,Monaco,Droid Sans Mono,Source Code Pro,Cascadia Code,Menlo,Consolas,DejaVu Sans Mono,monospace;
  --%NS%font-industrial:Bahnschrift,DIN Alternate,Franklin Gothic Medium,Nimbus Sans Narrow,sans-serif-condensed,sans-serif;
  --%NS%font-rounded-sans:ui-rounded,Hiragino Maru Gothic ProN,Quicksand,Comfortaa,Manjari,Arial Rounded MT,Arial Rounded MT Bold,Calibri,source-sans-pro,sans-serif;
  --%NS%font-slab-serif:Rockwell,Rockwell Nova,Roboto Slab,DejaVu Serif,Sitka Small,serif;
  --%NS%font-antique:Superclarendon,Bookman Old Style,URW Bookman,URW Bookman L,Georgia Pro,Georgia,serif;
  --%NS%font-didone:Didot,Bodoni MT,Noto Serif Display,URW Palladio L,P052,Sylfaen,serif;
  --%NS%font-handwritten:Segoe Print,Bradley Hand,Chilanka,TSCu_Comic,casual,cursive;
  --%NS%font-sans:var(--%NS%font-system-ui);
  --%NS%font-serif:ui-serif,serif;
  --%NS%font-mono:var(--%NS%font-monospace-code);
  --%NS%font-weight-1:100;
  --%NS%font-weight-2:200;
  --%NS%font-weight-3:300;
  --%NS%font-weight-4:400;
  --%NS%font-weight-5:500;
  --%NS%font-weight-6:600;
  --%NS%font-weight-7:700;
  --%NS%font-weight-8:800;
  --%NS%font-weight-9:900;
  --%NS%font-lineheight-00:.95;
  --%NS%font-lineheight-0:1.1;
  --%NS%font-lineheight-1:1.25;
  --%NS%font-lineheight-2:1.375;
  --%NS%font-lineheight-3:1.5;
  --%NS%font-lineheight-4:1.75;
  --%NS%font-lineheight-5:2;
  --%NS%font-letterspacing-0:-.05em;
  --%NS%font-letterspacing-1:.025em;
  --%NS%font-letterspacing-2:.050em;
  --%NS%font-letterspacing-3:.075em;
  --%NS%font-letterspacing-4:.150em;
  --%NS%font-letterspacing-5:.500em;
  --%NS%font-letterspacing-6:.750em;
  --%NS%font-letterspacing-7:1em;
  --%NS%font-size-00:.5rem;
  --%NS%font-size-0:.75rem;
  --%NS%font-size-1:1rem;
  --%NS%font-size-2:1.1rem;
  --%NS%font-size-3:1.25rem;
  --%NS%font-size-4:1.5rem;
  --%NS%font-size-5:2rem;
  --%NS%font-size-6:2.5rem;
  --%NS%font-size-7:3rem;
  --%NS%font-size-8:3.5rem;
  --%NS%font-size-fluid-0:max(.75rem,min(2vw,1rem));
  --%NS%font-size-fluid-1:max(1rem,min(4vw,1.5rem));
  --%NS%font-size-fluid-2:max(1.5rem,min(6vw,2.5rem));
  --%NS%font-size-fluid-3:max(2rem,min(9vw,3.5rem));
  --%NS%size-000:-.5rem;
  --%NS%size-00:-.25rem;
  --%NS%size-1:.25rem;
  --%NS%size-2:.5rem;
  ...
  --%NS%size-px-14:320px;
  --%NS%size-px-15:480px;
  --%NS%size-fluid-1:max(.5rem,min(1vw,1rem));
  --%NS%size-fluid-2:max(1rem,min(2vw,1.5rem));
  --%NS%size-fluid-3:max(1.5rem,min(3vw,2rem));
  --%NS%size-fluid-4:max(2rem,min(4vw,3rem));
  --%NS%size-fluid-5:max(4rem,min(5vw,5rem));
  --%NS%size-fluid-6:max(5rem,min(7vw,7.5rem));
  --%NS%size-fluid-7:max(7.5rem,min(10vw,10rem));
  --%NS%size-fluid-8:max(10rem,min(20vw,15rem));
  --%NS%size-fluid-9:max(15rem,min(30vw,20rem));
  --%NS%size-fluid-10:max(20rem,min(40vw,30rem));
  --%NS%size-content-1:20ch;
  --%NS%size-content-2:45ch;
  --%NS%size-content-3:60ch;
  --%NS%size-header-1:20ch;
  --%NS%size-header-2:25ch;
  --%NS%size-header-3:35ch;
  --%NS%size-xxs:240px;
  --%NS%size-xs:360px;
  --%NS%size-sm:480px;
  --%NS%size-md:768px;
  ...
  --%NS%size-xl:1440px;
  --%NS%size-xxl:1920px;
  --%NS%size-relative-000:-.5ch;
  --%NS%size-relative-00:-.25ch;
  --%NS%size-relative-1:.25ch;
  --%NS%size-relative-2:.5ch;
  --%NS%size-relative-3:1ch;
  --%NS%size-relative-4:1.25ch;
  --%NS%size-relative-5:1.5ch;
  --%NS%size-relative-6:1.75ch;
  --%NS%size-relative-7:2ch;
  --%NS%size-relative-8:3ch;
  --%NS%size-relative-9:4ch;
  --%NS%size-relative-10:5ch;
  --%NS%size-relative-11:7.5ch;
  --%NS%size-relative-12:10ch;
  --%NS%size-relative-13:15ch;
  --%NS%size-relative-14:20ch;
  --%NS%size-relative-15:30ch;
  --%NS%ease-1:cubic-bezier(.25,0,.5,1);
  --%NS%ease-2:cubic-bezier(.25,0,.4,1);
  --%NS%ease-3:cubic-bezier(.25,0,.3,1);
  --%NS%ease-4:cubic-bezier(.25,0,.2,1);
  --%NS%ease-5:cubic-bezier(.25,0,.1,1);
  --%NS%ease-in-1:cubic-bezier(.25,0,1,1);
  --%NS%ease-in-2:cubic-bezier(.50,0,1,1);
  --%NS%ease-in-3:cubic-bezier(.70,0,1,1);
  --%NS%ease-in-4:cubic-bezier(.90,0,1,1);
  --%NS%ease-in-5:cubic-bezier(1,0,1,1);
  --%NS%ease-out-1:cubic-bezier(0,0,.75,1);
  --%NS%ease-out-2:cubic-bezier(0,0,.50,1);
  --%NS%ease-out-3:cubic-bezier(0,0,.3,1);
  --%NS%ease-out-4:cubic-bezier(0,0,.1,1);
  --%NS%ease-out-5:cubic-bezier(0,0,0,1);
  --%NS%ease-in-out-1:cubic-bezier(.1,0,.9,1);
  --%NS%ease-in-out-2:cubic-bezier(.3,0,.7,1);
  --%NS%ease-in-out-3:cubic-bezier(.5,0,.5,1);
  --%NS%ease-in-out-4:cubic-bezier(.7,0,.3,1);
  --%NS%ease-in-out-5:cubic-bezier(.9,0,.1,1);
  --%NS%ease-elastic-out-1:cubic-bezier(.5,.75,.75,1.25);
  --%NS%ease-elastic-out-2:cubic-bezier(.5,1,.75,1.25);
  --%NS%ease-elastic-out-3:cubic-bezier(.5,1.25,.75,1.25);
  --%NS%ease-elastic-out-4:cubic-bezier(.5,1.5,.75,1.25);
  --%NS%ease-elastic-out-5:cubic-bezier(.5,1.75,.75,1.25);
  --%NS%ease-elastic-in-1:cubic-bezier(.5,-0.25,.75,1);
  --%NS%ease-elastic-in-2:cubic-bezier(.5,-0.50,.75,1);
  --%NS%ease-elastic-in-3:cubic-bezier(.5,-0.75,.75,1);
  --%NS%ease-elastic-in-4:cubic-bezier(.5,-1.00,.75,1);
  --%NS%ease-elastic-in-5:cubic-bezier(.5,-1.25,.75,1);
  --%NS%ease-elastic-in-out-1:cubic-bezier(.5,-.1,.1,1.5);
  --%NS%ease-elastic-in-out-2:cubic-bezier(.5,-.3,.1,1.5);
  --%NS%ease-elastic-in-out-3:cubic-bezier(.5,-.5,.1,1.5);
  --%NS%ease-elastic-in-out-4:cubic-bezier(.5,-.7,.1,1.5);
  --%NS%ease-elastic-in-out-5:cubic-bezier(.5,-.9,.1,1.5);
  --%NS%ease-step-1:steps(2);
  --%NS%ease-step-2:steps(3);
  --%NS%ease-step-3:steps(4);
  --%NS%ease-step-4:steps(7);
  --%NS%ease-step-5:steps(10);
  --%NS%ease-elastic-1:var(--%NS%ease-elastic-out-1);
  --%NS%ease-elastic-2:var(--%NS%ease-elastic-out-2);
  --%NS%ease-elastic-3:var(--%NS%ease-elastic-out-3);
  --%NS%ease-elastic-4:var(--%NS%ease-elastic-out-4);
  --%NS%ease-elastic-5:var(--%NS%ease-elastic-out-5);
  --%NS%ease-squish-1:var(--%NS%ease-elastic-in-out-1);
  --%NS%ease-squish-2:var(--%NS%ease-elastic-in-out-2);
  --%NS%ease-squish-3:var(--%NS%ease-elastic-in-out-3);
  --%NS%ease-squish-4:var(--%NS%ease-elastic-in-out-4);
  --%NS%ease-squish-5:var(--%NS%ease-elastic-in-out-5);
  --%NS%ease-spring-1:linear(0,0.006,0.025 2.8%,0.101 6.1%,0.539 18.9%,0.721 25.3%,0.849 31.5%,0.937 38.1%,0.968 41.8%,0.991 45.7%,1.006 50.1%,1.015 55%,1.017 63.9%,1.001);
  --%NS%ease-spring-2:linear(0,0.007,0.029 2.2%,0.118 4.7%,0.625 14.4%,0.826 19%,0.902,0.962,1.008 26.1%,1.041 28.7%,1.064 32.1%,1.07 36%,1.061 40.5%,1.015 53.4%,0.999 61.6%,0.995 71.2%,1);
  --%NS%ease-spring-3:linear(0,0.009,0.035 2.1%,0.141 4.4%,0.723 12.9%,0.938 16.7%,1.017,1.077,1.121,1.149 24.3%,1.159,1.163,1.161,1.154 29.9%,1.129 32.8%,1.051 39.6%,1.017 43.1%,0.991,0.977 51%,0.974 53.8%,0.975 57.1%,0.997 69.8%,1.003 76.9%,1);
  --%NS%ease-spring-4:linear(0,0.009,0.037 1.7%,0.153 3.6%,0.776 10.3%,1.001,1.142 16%,1.185,1.209 19%,1.215 19.9% 20.8%,1.199,1.165 25%,1.056 30.3%,1.008 33%,0.973,0.955 39.2%,0.953 41.1%,0.957 43.3%,0.998 53.3%,1.009 59.1% 63.7%,0.998 78.9%,1);
  --%NS%ease-spring-5:linear(0,0.01,0.04 1.6%,0.161 3.3%,0.816 9.4%,1.046,1.189 14.4%,1.231,1.254 17%,1.259,1.257 18.6%,1.236,1.194 22.3%,1.057 27%,0.999 29.4%,0.955 32.1%,0.942,0.935 34.9%,0.933,0.939 38.4%,1 47.3%,1.011,1.017 52.6%,1.016 56.4%,1 65.2%,0.996 70.2%,1.001 87.2%,1);
  --%NS%ease-bounce-1:linear(0,0.004,0.016,0.035,0.063,0.098,0.141,0.191,0.25,0.316,0.391 36.8%,0.563,0.766,1 58.8%,0.946,0.908 69.1%,0.895,0.885,0.879,0.878,0.879,0.885,0.895,0.908 89.7%,0.946,1);
  --%NS%ease-bounce-2:linear(0,0.004,0.016,0.035,0.063,0.098,0.141 15.1%,0.25,0.391,0.562,0.765,1,0.892 45.2%,0.849,0.815,0.788,0.769,0.757,0.753,0.757,0.769,0.788,0.815,0.85,0.892 75.2%,1 80.2%,0.973,0.954,0.943,0.939,0.943,0.954,0.973,1);
  --%NS%ease-bounce-3:linear(0,0.004,0.016,0.035,0.062,0.098,0.141 11.4%,0.25,0.39,0.562,0.764,1 30.3%,0.847 34.8%,0.787,0.737,0.699,0.672,0.655,0.65,0.656,0.672,0.699,0.738,0.787,0.847 61.7%,1 66.2%,0.946,0.908,0.885 74.2%,0.879,0.878,0.879,0.885 79.5%,0.908,0.946,1 87.4%,0.981,0.968,0.96,0.957,0.96,0.968,0.981,1);
  --%NS%ease-bounce-4:linear(0,0.004,0.016 3%,0.062,0.141,0.25,0.391,0.562 18.2%,1 24.3%,0.81,0.676 32.3%,0.629,0.595,0.575,0.568,0.575,0.595,0.629,0.676 48.2%,0.811,1 56.2%,0.918,0.86,0.825,0.814,0.825,0.86,0.918,1 77.2%,0.94 80.6%,0.925,0.92,0.925,0.94 87.5%,1 90.9%,0.974,0.965,0.974,1);
  --%NS%ease-bounce-5:linear(0,0.004,0.016 2.5%,0.063,0.141,0.25 10.1%,0.562,1 20.2%,0.783,0.627,0.534 30.9%,0.511,0.503,0.511,0.534 38%,0.627,0.782,1 48.7%,0.892,0.815,0.769 56.3%,0.757,0.753,0.757,0.769 61.3%,0.815,0.892,1 68.8%,0.908 72.4%,0.885,0.878,0.885,0.908 79.4%,1 83%,0.954 85.5%,0.943,0.939,0.943,0.954 90.5%,1 93%,0.977,0.97,0.977,1);
  --%NS%ease-circ-in:cubic-bezier(.6,.04,.98,.335);
  --%NS%ease-circ-in-out:cubic-bezier(.785,.135,.15,.86);
  --%NS%ease-circ-out:cubic-bezier(.075,.82,.165,1);
  --%NS%ease-cubic-in:cubic-bezier(.55,.055,.675,.19);
  --%NS%ease-cubic-in-out:cubic-bezier(.645,.045,.355,1);
  --%NS%ease-cubic-out:cubic-bezier(.215,.61,.355,1);
  --%NS%ease-expo-in:cubic-bezier(.95,.05,.795,.035);
  --%NS%ease-expo-in-out:cubic-bezier(1,0,0,1);
  --%NS%ease-expo-out:cubic-bezier(.19,1,.22,1);
  --%NS%ease-quad-in:cubic-bezier(.55,.085,.68,.53);
  --%NS%ease-quad-in-out:cubic-bezier(.455,.03,.515,.955);
  --%NS%ease-quad-out:cubic-bezier(.25,.46,.45,.94);
  --%NS%ease-quart-in:cubic-bezier(.895,.03,.685,.22);
  --%NS%ease-quart-in-out:cubic-bezier(.77,0,.175,1);
  --%NS%ease-quart-out:cubic-bezier(.165,.84,.44,1);
  --%NS%ease-quint-in:cubic-bezier(.755,.05,.855,.06);
  --%NS%ease-quint-in-out:cubic-bezier(.86,0,.07,1);
  --%NS%ease-quint-out:cubic-bezier(.23,1,.32,1);
  --%NS%ease-sine-in:cubic-bezier(.47,0,.745,.715);
  --%NS%ease-sine-in-out:cubic-bezier(.445,.05,.55,.95);
  --%NS%ease-sine-out:cubic-bezier(.39,.575,.565,1);
  --%NS%layer-1:1;
  --%NS%layer-2:2;
  --%NS%layer-3:3;
  --%NS%layer-4:4;
  --%NS%layer-5:5;
  --%NS%layer-important:2147483647;
  --%NS%shadow-color:220 3% 15%;
  --%NS%shadow-strength:1%;
  --%NS%shadow-strength-3:calc(var(--%NS%shadow-strength) + 2%);
  --%NS%shadow-strength-4:calc(var(--%NS%shadow-strength) + 3%);
  --%NS%shadow-strength-5:calc(var(--%NS%shadow-strength) + 4%);
  --%NS%shadow-strength-6:calc(var(--%NS%shadow-strength) + 5%);
  --%NS%shadow-strength-7:calc(var(--%NS%shadow-strength) + 6%);
  --%NS%shadow-strength-8:calc(var(--%NS%shadow-strength) + 7%);
  --%NS%shadow-strength-10:calc(var(--%NS%shadow-strength) + 9%);
  --%NS%inner-shadow-highlight:inset 0 -.5px 0 0 #fff,inset 0 .5px 0 0 rgba(0,0,0,.067);
  --%NS%shadow-1:0 1px 2px -1px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-10));
  --%NS%shadow-2:0 3px 5px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 7px 14px -5px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-6));
  --%NS%shadow-3:0 -1px 3px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-3)),0 1px 2px -5px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-3)),0 2px 5px -5px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-5)),0 4px 12px -5px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-6)),0 12px 15px -5px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-8));
  --%NS%shadow-4:0 -2px 5px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-3)),0 1px 1px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 2px 2px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 5px 5px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-5)),0 9px 9px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-6)),0 16px 16px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-7));
  --%NS%shadow-5:0 -1px 2px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-3)),0 2px 1px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 5px 5px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 10px 10px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-5)),0 20px 20px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-6)),0 40px 40px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-8));
  --%NS%shadow-6:0 -1px 2px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-3)),0 3px 2px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 7px 5px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-4)),0 12px 10px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-5)),0 22px 18px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-6)),0 41px 33px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-7)),0 100px 80px -2px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-8));
  --%NS%inner-shadow-0:inset 0 0 0 1px hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-10));
  --%NS%inner-shadow-1:inset 0 1px 2px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-10)),var(--%NS%inner-shadow-highlight);
  --%NS%inner-shadow-2:inset 0 1px 4px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-10)),var(--%NS%inner-shadow-highlight);
  --%NS%inner-shadow-3:inset 0 2px 8px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-10)),var(--%NS%inner-shadow-highlight);
  --%NS%inner-shadow-4:inset 0 2px 14px 0 hsl(var(--%NS%shadow-color)/var(--%NS%shadow-strength-10)),var(--%NS%inner-shadow-highlight);
  --%NS%ratio-square:1;
  --%NS%ratio-landscape:4/3;
  --%NS%ratio-portrait:3/4;
  --%NS%ratio-widescreen:16/9;
  --%NS%ratio-ultrawide:18/5;
  --%NS%ratio-golden:1.6180/1;
  --%NS%gray-0:#f8f9fa;
  --%NS%gray-1:#f1f3f5;
  --%NS%gray-2:#e9ecef;
  --%NS%gray-3:#dee2e6;
  ...
  --%NS%jungle-12:#3d4d04;
  --%NS%gradient-space: ;
  --%NS%gradient-1:linear-gradient(
      to bottom right var(--%NS%gradient-space),#1f005c,#5b0060,#870160,#ac255e,#ca485c,#e16b5c,#f39060,#ffb56b);
  --%NS%gradient-2:linear-gradient(
      to bottom right var(--%NS%gradient-space),#48005c,#8300e2,#a269ff);
  --%NS%gradient-3:radial-gradient(
      circle at top right var(--%NS%gradient-space),#0ff,rgba(0,255,255,0)),radial-gradient(
      circle at bottom left var(--%NS%gradient-space),#ff1492,rgba(255,20,146,0));
  --%NS%gradient-4:linear-gradient(
      to bottom right var(--%NS%gradient-space),#00f5a0,#00d9f5);
  --%NS%gradient-5:conic-gradient(
      from -270deg at 75% 110% var(--%NS%gradient-space),#f0f,#fffaf0);
  --%NS%gradient-6:conic-gradient(
      from -90deg at top left var(--%NS%gradient-space),#000,#fff);
  --%NS%gradient-7:linear-gradient(
      to bottom right var(--%NS%gradient-space),#72c6ef,#004e8f);
  --%NS%gradient-8:conic-gradient(
      from 90deg at 50% 0% var(--%NS%gradient-space),#111,50%,#222,#111);
  --%NS%gradient-9:conic-gradient(
      from .5turn at bottom center var(--%NS%gradient-space),#add8e6,#fff);
  --%NS%gradient-10:conic-gradient(
      from 90deg at 40% -25% var(--%NS%gradient-space),gold,#f79d03,#ee6907,#e6390a,#de0d0d,#d61039,#cf1261,#c71585,#cf1261,#d61039,#de0d0d,#ee6907,#f79d03,gold,gold,gold);
  --%NS%gradient-11:conic-gradient(
      at bottom left var(--%NS%gradient-space),#ff1493,cyan);
  --%NS%gradient-12:conic-gradient(
      from 90deg at 25% -10% var(--%NS%gradient-space),#ff4500,#d3f340,#7bee85,#afeeee,#7bee85);
  --%NS%gradient-13:radial-gradient(
      circle at 50% 200% var(--%NS%gradient-space),#000142,#3b0083,#b300c3,#ff059f,#ff4661,#ffad86,#fff3c7);
  --%NS%gradient-14:conic-gradient(
      at top right var(--%NS%gradient-space),lime,cyan);
  --%NS%gradient-15:linear-gradient(
      to bottom right var(--%NS%gradient-space),#c7d2fe,#fecaca,#fef3c7);
  --%NS%gradient-16:radial-gradient(
      circle at 50% -250% var(--%NS%gradient-space),#374151,#111827,#000);
  --%NS%gradient-17:conic-gradient(
      from -90deg at 50% -25% var(--%NS%gradient-space),blue,#8a2be2);
  --%NS%gradient-18:linear-gradient(
      0deg var(--%NS%gradient-space),rgba(255,0,0,.8),rgba(255,0,0,0) 75%),linear-gradient(
      60deg var(--%NS%gradient-space),rgba(255,255,0,.8),rgba(255,255,0,0) 75%),linear-gradient(
      120deg var(--%NS%gradient-space),rgba(0,255,0,.8),rgba(0,255,0,0) 75%),linear-gradient(
      180deg var(--%NS%gradient-space),rgba(0,255,255,.8),rgba(0,255,255,0) 75%),linear-gradient(
      240deg var(--%NS%gradient-space),rgba(0,0,255,.8),rgba(0,0,255,0) 75%),linear-gradient(
      300deg var(--%NS%gradient-space),rgba(255,0,255,.8),rgba(255,0,255,0) 75%);
  --%NS%gradient-19:linear-gradient(
      to bottom right var(--%NS%gradient-space),#ffe259,#ffa751);
  --%NS%gradient-20:conic-gradient(
      from -135deg at -10% center var(--%NS%gradient-space),orange,#ff7715,#ff522a,#ff3f47,#ff5482,#ff69b4);
  --%NS%gradient-21:conic-gradient(
      from -90deg at 25% 115% var(--%NS%gradient-space),red,#f06,#f0c,#c0f,#60f,#00f,#00f,#00f,#00f);
  --%NS%gradient-22:linear-gradient(
      to bottom right var(--%NS%gradient-space),#acb6e5,#86fde8);
  --%NS%gradient-23:linear-gradient(
      to bottom right var(--%NS%gradient-space),#536976,#292e49);
  --%NS%gradient-24:conic-gradient(
      from .5turn at 0% 0% var(--%NS%gradient-space),#00c476,10%,#82b0ff,90%,#00c476);
  --%NS%gradient-25:conic-gradient(
      at 125% 50% var(--%NS%gradient-space),#b78cf7,#ff7c94,#ffcf0d,#ff7c94,#b78cf7);
  --%NS%gradient-26:linear-gradient(
      to bottom right var(--%NS%gradient-space),#9796f0,#fbc7d4);
  --%NS%gradient-27:conic-gradient(
      from .5turn at bottom left var(--%NS%gradient-space),#ff1493,#639);
  --%NS%gradient-28:conic-gradient(
      from -90deg at 50% 105% var(--%NS%gradient-space),#fff,orchid);
  --%NS%gradient-29:radial-gradient(
      circle at top right var(--%NS%gradient-space),#bfb3ff,rgba(191,179,255,0)),radial-gradient(
      circle at bottom left var(--%NS%gradient-space),#86acf9,rgba(134,172,249,0));
  --%NS%gradient-30:radial-gradient(
      circle at top right var(--%NS%gradient-space),#00ff80,rgba(0,255,128,0)),radial-gradient(
      circle at bottom left var(--%NS%gradient-space),#adffd6,rgba(173,255,214,0));
  --%NS%noise-1:url("data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='a'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='.005' numOctaves='2' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23a)'/%3E%3C/svg%3E");
  --%NS%noise-2:url("data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 300 300' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='a'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='.05' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23a)'/%3E%3C/svg%3E");
  --%NS%noise-3:url("data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='a'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='.25' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23a)'/%3E%3C/svg%3E");
  --%NS%noise-4:url("data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 2056 2056' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='a'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='.5' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23a)'/%3E%3C/svg%3E");
  --%NS%noise-5:url("data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 2056 2056' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='a'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='.75' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23a)'/%3E%3C/svg%3E");
  --%NS%noise-filter-1:contrast(300%) brightness(100%);
  --%NS%noise-filter-2:contrast(200%) brightness(150%);
  --%NS%noise-filter-3:contrast(200%) brightness(250%);
  --%NS%noise-filter-4:contrast(200%) brightness(500%);
  --%NS%noise-filter-5:contrast(200%) brightness(1000%);
  --%NS%animation-fade-in:fade-in .5s var(--%NS%ease-3);
  --%NS%animation-fade-in-bloom:fade-in-bloom 2s var(--%NS%ease-3);
  --%NS%animation-fade-out:fade-out .5s var(--%NS%ease-3);
  --%NS%animation-fade-out-bloom:fade-out-bloom 2s var(--%NS%ease-3);
  --%NS%animation-scale-up:scale-up .5s var(--%NS%ease-3);
  --%NS%animation-scale-down:scale-down .5s var(--%NS%ease-3);
  --%NS%animation-slide-out-up:slide-out-up .5s var(--%NS%ease-3);
  --%NS%animation-slide-out-down:slide-out-down .5s var(--%NS%ease-3);
  --%NS%animation-slide-out-right:slide-out-right .5s var(--%NS%ease-3);
  --%NS%animation-slide-out-left:slide-out-left .5s var(--%NS%ease-3);
  --%NS%animation-slide-in-up:slide-in-up .5s var(--%NS%ease-3);
  --%NS%animation-slide-in-down:slide-in-down .5s var(--%NS%ease-3);
  --%NS%animation-slide-in-right:slide-in-right .5s var(--%NS%ease-3);
  --%NS%animation-slide-in-left:slide-in-left .5s var(--%NS%ease-3);
  --%NS%animation-shake-x:shake-x .75s var(--%NS%ease-out-5);
  --%NS%animation-shake-y:shake-y .75s var(--%NS%ease-out-5);
  --%NS%animation-shake-z:shake-z 1s var(--%NS%ease-in-out-3);
  --%NS%animation-spin:spin 2s linear infinite;
  --%NS%animation-ping:ping 5s var(--%NS%ease-out-3) infinite;
  --%NS%animation-blink:blink 1s var(--%NS%ease-out-3) infinite;
  --%NS%animation-float:float 3s var(--%NS%ease-in-out-3) infinite;
  --%NS%animation-bounce:bounce 2s var(--%NS%ease-squish-2) infinite;
  --%NS%animation-pulse:pulse 2s var(--%NS%ease-out-3) infinite;
  --%NS%border-size-1:1px;
  --%NS%border-size-2:2px;
  --%NS%border-size-3:5px;
  --%NS%border-size-4:10px;
  --%NS%border-size-5:25px;
  --%NS%radius-1:2px;
  --%NS%radius-2:5px;
  --%NS%radius-3:1rem;
  --%NS%radius-4:2rem;
  --%NS%radius-5:4rem;
  --%NS%radius-6:8rem;
  --%NS%radius-drawn-1:255px 15px 225px 15px/15px 225px 15px 255px;
  --%NS%radius-drawn-2:125px 10px 20px 185px/25px 205px 205px 25px;
  --%NS%radius-drawn-3:15px 255px 15px 225px/225px 15px 255px 15px;
  --%NS%radius-drawn-4:15px 25px 155px 25px/225px 150px 25px 115px;
  --%NS%radius-drawn-5:250px 25px 15px 20px/15px 80px 105px 115px;
  --%NS%radius-drawn-6:28px 100px 20px 15px/150px 30px 205px 225px;
  --%NS%radius-round:1e5px;
  --%NS%radius-blob-1:30% 70% 70% 30%/53% 30% 70% 47%;
  --%NS%radius-blob-2:53% 47% 34% 66%/63% 46% 54% 37%;
  --%NS%radius-blob-3:37% 63% 56% 44%/49% 56% 44% 51%;
  --%NS%radius-blob-4:63% 37% 37% 63%/43% 37% 63% 57%;
  --%NS%radius-blob-5:49% 51% 48% 52%/57% 44% 56% 43%;
  --%NS%radius-conditional-1:clamp(0px,calc(100vw - 100%) * 1e5,var(--%NS%radius-1));
  --%NS%radius-conditional-2:clamp(0px,calc(100vw - 100%) * 1e5,var(--%NS%radius-2));
  --%NS%radius-conditional-3:clamp(0px,calc(100vw - 100%) * 1e5,var(--%NS%radius-3));
  --%NS%radius-conditional-4:clamp(0px,calc(100vw - 100%) * 1e5,var(--%NS%radius-4));
  --%NS%radius-conditional-5:clamp(0px,calc(100vw - 100%) * 1e5,var(--%NS%radius-5));
  --%NS%radius-conditional-6:clamp(0px,calc(100vw - 100%) * 1e5,var(--%NS%radius-6));
  --%NS%palette-hue:250;
  --%NS%palette-hue-rotate-by:0;
  --%NS%palette-chroma:0.15;
  --%NS%color-1:oklch(98% calc(var(--%NS%palette-chroma)*0.03) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*0));
  --%NS%color-2:oklch(97% calc(var(--%NS%palette-chroma)*0.06) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*1));
  --%NS%color-3:oklch(93% calc(var(--%NS%palette-chroma)*0.1) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*2));
  --%NS%color-4:oklch(84% calc(var(--%NS%palette-chroma)*0.12) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*3));
  --%NS%color-5:oklch(80% calc(var(--%NS%palette-chroma)*0.16) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*4));
  --%NS%color-6:oklch(71% calc(var(--%NS%palette-chroma)*0.19) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*5));
  --%NS%color-7:oklch(66% calc(var(--%NS%palette-chroma)*0.2) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*6));
  --%NS%color-8:oklch(58% calc(var(--%NS%palette-chroma)*0.21) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*7));
  --%NS%color-9:oklch(53% calc(var(--%NS%palette-chroma)*0.2) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*8));
  --%NS%color-10:oklch(49% calc(var(--%NS%palette-chroma)*0.19) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*9));
  --%NS%color-11:oklch(42% calc(var(--%NS%palette-chroma)*0.17) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*10));
  --%NS%color-12:oklch(35% calc(var(--%NS%palette-chroma)*0.15) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*11));
  --%NS%color-13:oklch(27% calc(var(--%NS%palette-chroma)*0.12) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*12));
  --%NS%color-14:oklch(20% calc(var(--%NS%palette-chroma)*0.09) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*13));
  --%NS%color-15:oklch(16% calc(var(--%NS%palette-chroma)*0.07) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*14));
  --%NS%color-16:oklch(10% calc(var(--%NS%palette-chroma)*0.05) calc(var(--%NS%palette-hue) + var(--%NS%palette-hue-rotate-by)*15));
}
@media (prefers-color-scheme: dark) {
  :where(html[_ngcontent-%COMP%]) {
    --%NS%shadow-color:220 40% 2%;
    --%NS%shadow-strength:25%;
    --%NS%inner-shadow-highlight:inset 0 -.5px 0 0 hsla(0,0%,100%,.067),inset 0 .5px 0 0 rgba(0,0,0,.467);
  }
}
@supports (background:linear-gradient(to right in oklab, #000, #fff)) {
  :where(html[_ngcontent-%COMP%]) {
    --%NS%gradient-space:in oklab;
  }
}
...
:where(html[_ngcontent-%COMP%]) {
  --%NS%csstools-color-scheme--light:initial;
  --%NS%link:var(--%NS%indigo-7);
  --%NS%link-visited:var(--%NS%purple-7);
  --%NS%text-1:var(--%NS%gray-12);
  --%NS%text-2:var(--%NS%gray-7);
  --%NS%surface-1:var(--%NS%gray-0);
  --%NS%surface-2:var(--%NS%gray-2);
  --%NS%surface-3:var(--%NS%gray-3);
  --%NS%surface-4:var(--%NS%gray-4);
  --%NS%scrollthumb-color:var(--%NS%gray-7);
  -webkit-text-size-adjust: none;
  accent-color: var(--%NS%brand,var(--%NS%link));
  background-color: var(--%NS%surface-1);
  block-size: 100%;
  caret-color: var(--%NS%brand,var(--%NS%link));
  color: var(--%NS%text-1);
  color-scheme: light;
  font-family: var(--%NS%font-system-ui);
  line-height: var(--%NS%font-lineheight-3);
  scrollbar-color: var(--%NS%scrollthumb-color) transparent;
}
@media (dynamic-range: high) or (color-gamut: p3) {
  @supports (color:color(display-p3 0 0 0)) {
    :where(html[_ngcontent-%COMP%]) {
      --%NS%link:color(display-p3 .1 .39 1);
      --%NS%link-visited:color(display-p3 .6 .2 1);
    }
  }
}
...
@media (prefers-color-scheme: dark) {
  :where(html[_ngcontent-%COMP%]) {
    --%NS%csstools-color-scheme--light: ;
    --%NS%link:var(--%NS%indigo-3);
    --%NS%link-visited:var(--%NS%purple-3);
    --%NS%text-1:var(--%NS%gray-1);
    --%NS%text-2:var(--%NS%gray-4);
    --%NS%surface-1:var(--%NS%gray-9);
    --%NS%surface-2:var(--%NS%gray-8);
    --%NS%surface-3:var(--%NS%gray-7);
    --%NS%surface-4:var(--%NS%gray-6);
    --%NS%scrollthumb-color:var(--%NS%gray-6);
    --%NS%shadow-strength:10%;
    --%NS%shadow-color:220 40% 2%;
    color-scheme: dark;
  }
}
:where(a[href][_ngcontent-%COMP%]) {
  color: var(--%NS%brand,var(--%NS%link));
}
:where(a[href][_ngcontent-%COMP%]):where([_ngcontent-%COMP%]:visited) {
  color: var(--%NS%link-visited);
}
[_ngcontent-%COMP%]:focus-visible {
  outline-color: var(--%NS%brand,var(--%NS%link));
}
*[_ngcontent-%COMP%], 
...
@media (prefers-reduced-motion: no-preference) {
  :where([_ngcontent-%COMP%]:focus-visible) {
    transition: outline-offset 145ms var(--%NS%ease-2);
  }
...
:where(input[_ngcontent-%COMP%]:not([type=range]), textarea[_ngcontent-%COMP%]) {
  padding-block: var(--%NS%size-1);
  padding-inline: var(--%NS%size-2);
}
:where(select[_ngcontent-%COMP%]) {
  field-sizing: content;
  padding-block: .75ch;
  padding-inline: var(--%NS%size-relative-4) 0;
}
...
:where([_ngcontent-%COMP%]:not(pre)    > code[_ngcontent-%COMP%]) {
  ...
  border-radius: var(--%NS%radius-2);
  padding: var(--%NS%size-1) var(--%NS%size-2);
  writing-mode: lr;
}
:where(kbd[_ngcontent-%COMP%], var[_ngcontent-%COMP%]) {
  border-color: var(--%NS%surface-4);
  border-radius: var(--%NS%radius-2);
  border-width: var(--%NS%border-size-1);
  padding: var(--%NS%size-1) var(--%NS%size-2);
}
:where(mark[_ngcontent-%COMP%]) {
  border-radius: var(--%NS%radius-2);
  padding-inline: var(--%NS%size-1);
}
:where(ol[_ngcontent-%COMP%], ul[_ngcontent-%COMP%]) {
  padding-inline-start: var(--%NS%size-8);
}
:where(li[_ngcontent-%COMP%]) {
  padding-inline-start: var(--%NS%size-2);
}
:where(li[_ngcontent-%COMP%], dd[_ngcontent-%COMP%], figcaption[_ngcontent-%COMP%]) {
  max-inline-size: var(--%NS%size-content-2);
}
:where(p[_ngcontent-%COMP%]) {
  text-wrap: pretty;
  max-inline-size: var(--%NS%size-content-3);
}
...
:where(dt[_ngcontent-%COMP%]:not(:first-of-type)) {
  margin-block-start: var(--%NS%size-5);
}
:where(small[_ngcontent-%COMP%]) {
  font-size: max(.5em, var(--%NS%font-size-0));
  max-inline-size: var(--%NS%size-content-1);
}
:where(hr[_ngcontent-%COMP%]) {
  background-color: var(--%NS%surface-3);
  height: var(--%NS%border-size-2);
  margin-block: var(--%NS%size-fluid-5);
}
...
:where(figure[_ngcontent-%COMP%])    > :where(figcaption[_ngcontent-%COMP%]) {
  text-wrap: balance;
  font-size: var(--%NS%font-size-1);
}
:where(blockquote[_ngcontent-%COMP%], [_ngcontent-%COMP%]:not(blockquote)    > cite[_ngcontent-%COMP%]) {
  border-inline-start-width: var(--%NS%border-size-3);
}
:where(blockquote[_ngcontent-%COMP%]) {
  display: grid;
  gap: var(--%NS%size-3);
  max-inline-size: var(--%NS%size-content-2);
  padding-block: var(--%NS%size-3);
  padding-inline: var(--%NS%size-4);
}
...
:where(summary[_ngcontent-%COMP%]) {
  ...
  border-radius: var(--%NS%radius-2);
  margin: calc(var(--%NS%size-2)*-1) calc(var(--%NS%size-3)*-1);
  padding: var(--%NS%size-2) var(--%NS%size-3);
}
:where(details[_ngcontent-%COMP%]) {
  background: var(--%NS%surface-2);
  border-radius: var(--%NS%radius-2);
  padding-block: var(--%NS%size-2);
  padding-inline: var(--%NS%size-3);
}
:where(details[open][_ngcontent-%COMP%]    > summary[_ngcontent-%COMP%]) {
  border-end-end-radius: 0;
  border-end-start-radius: 0;
  margin-bottom: var(--%NS%size-2);
}
:where(fieldset[_ngcontent-%COMP%]) {
  border: var(--%NS%border-size-1) solid var(--%NS%surface-4);
  border-radius: var(--%NS%radius-2);
}
:where(del[_ngcontent-%COMP%]) {
  background: var(--%NS%red-9);
  color: var(--%NS%red-2);
}
:where(ins[_ngcontent-%COMP%]) {
  background: var(--%NS%green-9);
  color: var(--%NS%green-1);
}
:where(abbr[_ngcontent-%COMP%]) {
  text-decoration-color: var(--%NS%blue-5);
}
:where(dialog[_ngcontent-%COMP%]) {
  background-color: var(--%NS%surface-1);
  border-radius: var(--%NS%radius-3);
  box-shadow: var(--%NS%shadow-6);
  color: inherit;
}
...
:where(table[_ngcontent-%COMP%]) {
  --%NS%nice-inner-radius:calc(var(--%NS%radius-3) - 2px);
  background: var(--%NS%surface-2);
...
tr[_ngcontent-%COMP%]:nth-child(odd) {
  background-color: var(--%NS%surface-0);
}`] });
  }
};
(() => {
