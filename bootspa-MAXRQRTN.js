...
} from "./chunk-CR4UHDCW.js";
import {
  isGuardsCheckEnd,
  updateRouteInfo
} from "./chunk-6V2SCYUN.js";
import "./chunk-2MBADEWB.js";
import {
  Router,
  RouterOutlet,
  provideRouter,
  withComponentInputBinding
} from "./chunk-CLHDD7YE.js";
import {
  Meta,
  Title,
...
var routes = [
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./blogs.component-QWLHOYTK.js").then((m2) => m2.BlogsComponent)
  ...
  __spreadValues({
    path: "mqtt",
    loadChildren: () => import("./mqtt.routes-NPVB2VHN.js").then((m2) => m2.routes)
  }, false ? { \u0275entryName: "app/mqtt/mqtt.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./demo.component-VG3QEF4I.js").then((m2) => m2.DemoComponent),
    children: [
      {
        path: "filterSamp",
        data: {
        ...
        loadComponent: () => import("./filter-sample.component-FUNM2KY2.js").then((m2) => m2.FilterSampleComponent)
      },
      {
        path: "modalSamp",
        loadComponent: () => import("./modal-demo.component-B6PPULUP.js").then((m2) => m2.ModalDemoComponent)
      },
      {
        path: "mixinSamp",
        loadComponent: () => import("./mixins.component-D5KCRGU4.js").then((m2) => m2.MixinsComponent)
      },
      {
        path: "htmlLoad",
        loadComponent: () => import("./htmlload.component-7YLEEXL2.js").then((m2) => m2.HtmlloadComponent)
      },
      // {
      //   path: 'popup',
      //   outlet: 'popup',
      ...
      // },
      {
        ...
        loadComponent: () => import("./required-attributes.component-MVG7YH6B.js").then((m2) => m2.RequiredAttributesComponent)
      },
      // {
      //   path: 'viewModel',
      ...
      {
        path: "complexAPI",
        loadComponent: () => import("./apisample.component-TJVM5EF5.js").then((m2) => m2.APISampleComponent)
      },
      {
        path: "pokeAPI",
        loadComponent: () => import("./pokemain.component-3ML4A2VF.js").then((m2) => m2.PokeMainComponent)
      },
      {
        path: "observableState",
        loadChildren: () => import("./observable-state.routes-6SS4KYDQ.js").then((m2) => m2.routes)
      },
      {
        path: "DirectiveSamp",
        loadComponent: () => import("./directives-sample.component-GVWFZJ62.js").then((m2) => m2.DirectivesSampleComponent)
      },
      {
        path: "svg",
        loadComponent: () => import("./svg-calender.component-5I3HYWB4.js").then((m2) => m2.SvgCalenderComponent)
      },
      {
        path: "testOb",
        loadChildren: () => import("./test.routes-XUULZF5V.js").then((module) => module.routes)
      },
      {
        path: "home",
      ...
      {
        path: "dynhtml",
        loadComponent: () => import("./dynamichtml.component-DCYAR5SN.js").then((m2) => m2.DynamicHtmlComponent)
      },
      {
        path: "snow",
        loadComponent: () => import("./snow.component-4EEAAKBG.js").then((m2) => m2.SnowComponent)
      },
      {
        path: "tumblr",
        loadComponent: () => import("./tumblr.component-NXAX5WTV.js").then((m2) => m2.TumblrComponent)
      },
      {
        path: "bigData",
        loadComponent: () => import("./big-data.component-ZGNE55T4.js").then((m2) => m2.BigDataComponent)
      },
      {
        path: "svgTest",
        loadComponent: () => import("./svg-test.component-ZJ4HS67V.js").then((m2) => m2.SvgTestComponent)
      },
      {
        path: "pannel",
        loadComponent: () => import("./pannel-stuff.component-WG66QJCP.js").then((m2) => m2.PannelStuffComponent)
      },
      {
        path: "clock",
        loadComponent: () => import("./analog-clock.component-4PJRX27X.js").then((m2) => m2.AnalogClockComponent)
      },
      {
        path: "gridThings",
        loadComponent: () => import("./gridthings.component-QWVROW7F.js").then((m2) => m2.GridthingsComponent)
      },
      {
        path: "bintree",
        loadComponent: () => import("./bintree.component-KD4JBAIL.js").then((m2) => m2.BintreeComponent)
      },
      {
        path: "localState",
        loadChildren: () => import("./local-state.routes-JOFFYEK6.js").then((m2) => m2.routes)
      },
      {
        path: "lazyComponents",
        loadComponent: () => import("./lazy-component.component-DD3SVC3S.js").then((m2) => m2.LazyComponentComponent)
      },
      {
        path: "svgTimer",
        loadComponent: () => import("./svg-timer.component-MIDAGNS4.js").then((m2) => m2.SvgTimerComponent)
      },
      {
        path: "svgClock",
        loadComponent: () => import("./svg-clock.component-5VWJS7GD.js").then((m2) => m2.SvgClockComponent)
      },
      {
        path: "dynForm",
        loadComponent: () => import("./dyn-form.component-YBYABTPY.js").then((m2) => m2.DynFormComponent)
      },
      {
        path: "rxjsTest",
        loadComponent: () => import("./rxjstest.component-6BN5E2RS.js").then((m2) => m2.RxjstestComponent)
      },
      {
        path: "unsubSample",
        loadComponent: () => import("./unsub-sample.component-W42SFYTR.js").then((m2) => m2.UnsubSampleComponent)
      },
      {
        path: "unsubSample/:id",
        loadComponent: () => import("./unsub-sample.component-W42SFYTR.js").then((m2) => m2.UnsubSampleComponent)
      },
      { path: "rvt", loadChildren: () => import("./routes-RBCAETWC.js") },
      {
        path: "gridCalender",
        loadComponent: () => import("./grid-calender.component-XJ5UIFLH.js").then((m2) => m2.GridCalenderComponent)
      },
      {
        path: "summary",
        loadComponent: () => import("./html-summary.component-OL67EUYJ.js").then((m2) => m2.HtmlSummaryComponent)
      },
      {
        path: "resizePanel",
        loadComponent: () => import("./resizable-panels.component-HDIECU6K.js").then((m2) => m2.ResizablePanelsComponent)
      },
      {
        path: "signalsInForm",
        loadComponent: () => import("./signals-form.component-V33PKIQK.js").then((m2) => m2.SignalsFormsComponent)
      },
      {
        path: "card",
        loadComponent: () => import("./card.component-K7YOBR55.js").then((m2) => m2.CardComponent)
      },
      {
        path: "cells",
        loadComponent: () => import("./cells.component-HOJGKEVT.js").then((m2) => m2.CellsComponent)
      },
      {
        path: "cellsRaw",
        loadComponent: () => import("./cell-raw.component-SB42GAJ5.js").then((m2) => m2.CellRawComponent)
      },
      {
        path: "routeList",
        loadComponent: () => import("./route-list.component-NLEKNHWQ.js").then((m2) => m2.RouteListComponent)
      },
      {
        path: "formErrors",
        loadComponent: () => import("./form-error.component-HPQF7JSD.js")
      },
      {
        path: "dialog",
        loadComponent: () => import("./dialog.component-2LDVVYJC.js")
      },
      {
        path: "signalInputMusings",
        loadComponent: () => import("./signal-input-musings.component-5TPTFMXJ.js").then((m2) => m2.SignalInputMusingsComponent)
      },
      {
        path: "signalPlay",
        loadComponent: () => import("./signal-play.component-S2UUTWFJ.js")
      },
      // {
      //   path: 'signalError',
      ...
      {
        path: "eventedOutputs",
        loadComponent: () => import("./evented-outputs.component-J5RP64YJ.js").then((m2) => m2.EventedOutputsComponent)
      },
      {
        path: "indexDb",
        loadComponent: () => import("./indexdb.component-3YWWJGJZ.js").then((m2) => m2.IndexdbComponent),
        title: "IndexDb sample"
      },
      {
        path: "acnhorPosition",
        loadComponent: () => import("./anchor-pos.component-E3Q3XLWB.js").then((m2) => m2.AnchorPosComponent),
        title: "Anchor Position demo"
      },
      {
        path: "outOfOrder",
        loadComponent: () => import("./out-of-order.component-SFDXE5Q4.js").then((m2) => m2.OutOfOrderComponent)
      },
      {
        path: "stepper",
        loadComponent: () => import("./stepper.component-K5FLIDJC.js").then((m2) => m2.StepperComponent)
      },
      {
        path: "iconSprite",
        loadComponent: () => import("./icon-sprite.component-AAVQERWC.js").then((m2) => m2.IconSpriteComponent)
      },
      {
        path: "reusableDialog",
        loadComponent: () => import("./reusable-dialog.component-47CIBT3Q.js").then((m2) => m2.ReusableDialogComponent)
      },
      {
        path: "tableHover",
        loadComponent: () => import("./table-hover.component-VJOEWGGN.js").then((m2) => m2.TableHoverComponent)
      },
      {
        path: "signalDebounce",
        loadComponent: () => import("./signal-debounce.component-N5FHFRTR.js").then((m2) => m2.SignalDebounce)
      },
      {
        path: "crudStuff",
        loadComponent: () => import("./crud-stuff.component-IZUY4OKC.js").then((m2) => m2.CrudStuffComponent)
      },
      {
        path: "customNativeForm",
        loadComponent: () => import("./custom-native-form.component-27VYF6FD.js").then((m2) => m2.CustomNativeFormComponent)
      },
      {
        path: "inputHostExperiment",
        loadComponent: () => import("./input-host-experiment.component-DOESJ35G.js").then((m2) => m2.InputHostExperimentComponent)
      },
      {
        path: "meteredView",
        loadComponent: () => import("./metered-view.component-SI6J5UUU.js").then((m2) => m2.MeteredViewComponent)
      },
      {
        path: "signalForms",
        loadComponent: () => import("./signal-forms-experiment.component-IDL76MN5.js").then((m2) => m2.SignalFormsExperimentComponent)
      },
      {
        path: "signalForms/tree",
        loadComponent: () => import("./signal-tree.component-TEFGVX6L.js").then((m2) => m2.SignalTreeComponent)
      },
      {
        path: "signalForms/dynamic",
        loadComponent: () => import("./dynamic.component-6YQ2PUAZ.js").then((m2) => m2.DynamicComponent)
      },
      {
        path: "toh",
        loadComponent: () => import("./toh.component-Z3SDTON6.js").then((m2) => m2.TohComponent)
      },
      {
        path: "toh/cdk",
        loadComponent: () => import("./toh-cdk.component-3NCS7RAQ.js").then((m2) => m2.TohCdkComponent)
      },
      {
        path: "vt",
        loadComponent: () => import("./view-transitions.component-6PVLEVBQ.js").then((m2) => m2.ViewTransitionsComponent)
      },
      {
        path: "inMem",
        loadComponent: () => import("./in-mem-sample.component-GWOSYP6M.js").then((m2) => m2.InMemSampleComponent)
      },
      {
        path: "dynSignalForm",
        loadComponent: () => import("./dynsignal-form.component-QWA2N4VM.js").then((m2) => m2.DynsignalFormComponent)
      },
      {
        path: "dyn-route",
        loadChildren: () => import("./dyn-routes.routes-VQOW2RMC.js").then((m2) => m2.dynRoutes)
      },
      {
        path: "timer",
        loadComponent: () => import("./timer.component-DKOEZHQA.js").then((m2) => m2.TimerComponent)
      },
      {
        path: "temporal",
        loadComponent: () => import("./temporal.component-GT4DWQZ6.js").then((m2) => m2.TemporalComponent)
      },
      {
        path: "gridPlay",
        loadComponent: () => import("./grid-play.component-7B23C7SS.js").then((m2) => m2.GridPlayComponent)
      },
      {
        path: "caddy",
        loadComponent: () => import("./caddy.component-YQXBV34M.js").then((m2) => m2.CaddyComponent)
      },
      {
        path: "boxes",
        loadComponent: () => import("./boxes.component-FXBPZNIO.js").then((m2) => m2.BoxesComponent)
      },
