import {
  Bloglist
} from "./chunk-6KJ7ACWE.js";
import "./chunk-OC7IMHPC.js";
import {
  DomSanitizer,
  Title
...
var BlogsComponent_Defer_1_DepsFn = () => [
  /* @ts-ignore */
  import("./blog-list.component-GP7SNPHC.js").then((m) => m.BlogListComponent)
];
  ...
  constructor() {
    ...
    this.testblog = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "testblog" } : (
      ...
      loader: async ({ params }) => {
        ...
        if (content) {
          const { parser } = await import("./parser-ROK3WOTD.js");
