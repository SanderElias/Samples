...
var TohComponent = class _TohComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TohComponent, selectors: [["ng-component"]], decls: 12, vars: 4, consts: [[1, "stack"], [1, "label"], [1, "row"], ["type", "range", "min", "3", "max", "10", 3, "input", "value"], ["type", "range", "min", "3", "max", "5", 3, "input", "value"], ["draggable", "true", 1, "puck", 3, "--%NS%size"], ["draggable", "true", 1, "puck"]], template: function TohComponent_Template(rf, ctx) {
      if (rf & 1) {
