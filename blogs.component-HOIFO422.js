import {
  Bloglist
} from "./chunk-RPQYOYWH.js";
import "./chunk-Y6AKH4L3.js";
import {
  DomSanitizer,
  Title
...
var BlogsComponent_Defer_1_DepsFn = () => [
  /* @ts-ignore */
  import("./blog-list.component-AVCDUFAP.js").then((m) => m.BlogListComponent)
];
function BlogsComponent_Defer_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate(ctx_r0.blogList.getBlogById(ctx_r0.id())?.title || "Welcome to the blog");
    \u0275\u0275advance(2);
  ...
  constructor() {
    ...
    this.testblog = resource(__spreadProps(__spreadValues({}, ngDevMode ? { debugName: "testblog" } : (
      ...
      loader: async ({ params }) => {
        ...
        if (content) {
          const { parser } = await import("./parser-R44NS6KQ.js");
