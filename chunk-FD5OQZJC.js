import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-BOEJGLZA.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-SFVUAGGE.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-KV5264BT-25GKFZNL.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-S5V4N54A-LEB2KMEI.js"), "loader")
      }
    ] : []
  ]);
