...
var CellRawComponent = class _CellRawComponent {
  ...
  static {
    ...
    }, styles: ['/* src/app/cells/cell-raw/cell-raw.component.css */\n@property --cellBg { syntax: "<color>"; inherits: true; initial-value: black; }\n@property --cellSize { syntax: "<length> | <percentage>"; inherits: true; initial-value: 1.25rem; }\n:root {\n  --%NS%cellBg: oklch(0.5 0.5 150);\n  --%NS%cellSize: 10px;\n}\n#outlet > se-cell-raw {\n  display: grid;\n  height: 95vh;\n  aspect-ratio: 1;\n  grid-template-columns: repeat(auto-fit, var(--%NS%cellSize));\n  grid-template-rows: repeat(auto-fit, var(--%NS%cellSize));\n  gap: 0.15rem;\n}\ncell {\n  display: block;\n  float: left;\n  margin: 1px;\n  width: var(--%NS%cellSize);\n  aspect-ratio: 1;\n  background-color: var(--%NS%cellBg);\n  border-radius: calc(var(--%NS%cellSize / 20));\n  padding: 0rem;\n  text-overflow: ellipsis;\n}\n'], encapsulation: 2 });
  }
};
(() => {
