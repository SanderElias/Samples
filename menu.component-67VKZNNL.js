...
var MenuComponent = class _MenuComponent {
  ...
  static {
    ...
    }, dependencies: [RouterLink], styles: ["\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  padding: var(--%NS%size-4);\n  gap: var(--%NS%size-4);\n}\na[_ngcontent-%COMP%] {\n  display: grid;\n  place-items: center;\n  inline-size: 100%;\n  max-inline-size: 100%;\n  min-block-size: var(--%NS%size-11);\n  max-block-size: 50dvb;\n  padding-block: var(--%NS%size-4);\n  padding-inline: var(--%NS%size-5);\n  border: var(--%NS%border-size-1) solid var(--%NS%surface-3);\n  border-radius: var(--%NS%radius-3);\n  background: var(--%NS%surface-2);\n  color: var(--%NS%text-1);\n  text-align: center;\n  text-decoration: none;\n  font-weight: var(--%NS%font-weight-6);\n  transition:\n    transform 120ms var(--%NS%ease-3),\n    box-shadow 160ms var(--%NS%ease-3),\n    background-color 160ms var(--%NS%ease-3),\n    border-color 160ms var(--%NS%ease-3);\n}\na[_ngcontent-%COMP%]:hover {\n  background: var(--%NS%surface-3);\n  border-color: var(--%NS%surface-4);\n  box-shadow: var(--%NS%shadow-2);\n}\na[_ngcontent-%COMP%]:focus-visible {\n  outline: var(--%NS%border-size-2) solid var(--%NS%link);\n  outline-offset: var(--%NS%size-1);\n  box-shadow: var(--%NS%shadow-3);\n}\na[_ngcontent-%COMP%]:active {\n  transform: translateY(var(--%NS%size-px-2));\n  box-shadow: var(--%NS%shadow-1);\n}"] });
  }
};
(() => {
