...
function loadMermaid() {
  if (!mermaidLoader) {
    mermaidLoader = import("./mermaid.core-MWDE7JEL.js").then(({ default: mermaid }) => mermaid);
  }
...
async function parser(content) {
  const { Marked } = await import("./marked.esm-OHRP25G3.js");
  let marked = new Marked();
  try {
    const { default: hljs } = await import("./core-BOGKX225.js");
    const { default: typescript } = await import("./typescript-GPY4CH74.js");
    const { default: css } = await import("./css-V3CL3LQT.js");
    const { default: html } = await import("./xml-5HVCHLY7.js");
    const { default: javascript } = await import("./javascript-ZD4LSQWJ.js");
    const { default: plaintext } = await import("./plaintext-6U4BAYYJ.js");
