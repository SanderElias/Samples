...
} from "./chunk-Y4CW77CI.js";
import {
  isGuardsCheckEnd,
  updateRouteInfo
} from "./chunk-EJDH2I5G.js";
import {
  toSignal
} from "./chunk-3WHD4E3U.js";
import {
  ActivatedRoute,
  Router,
  RouterOutlet,
...
} from "./chunk-BLZGKILO.js";
import "./chunk-KMTWG3DZ.js";
import {
  HttpClient,
  provideHttpClient,
  withInterceptors
} from "./chunk-VM2KEMGZ.js";
...
var routes = [
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./blogs.component-I5U724PE.js").then((m2) => m2.BlogsComponent)
  ...
  __spreadValues({
    path: "mqtt",
    loadChildren: () => import("./mqtt.routes-AA5K63R4.js").then((m2) => m2.routes)
  }, false ? { \u0275entryName: "app/mqtt/mqtt.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./demo.component-7LUHDVIF.js").then((m2) => m2.DemoComponent),
    children: [
      {
        path: "filterSamp",
        data: {
        ...
        loadComponent: () => import("./filter-sample.component-Q6CQB42U.js").then((m2) => m2.FilterSampleComponent)
      },
      {
        path: "modalSamp",
        loadComponent: () => import("./modal-demo.component-QK4E4MN5.js").then((m2) => m2.ModalDemoComponent)
      },
      {
        path: "mixinSamp",
        loadComponent: () => import("./mixins.component-YKJQW35F.js").then((m2) => m2.MixinsComponent)
      },
      {
        path: "htmlLoad",
        loadComponent: () => import("./htmlload.component-BWI523EK.js").then((m2) => m2.HtmlloadComponent)
      },
      // {
      //   path: 'popup',
      //   outlet: 'popup',
      ...
      // },
      {
        ...
        loadComponent: () => import("./required-attributes.component-PYT3KCNL.js").then((m2) => m2.RequiredAttributesComponent)
      },
      // {
      //   path: 'viewModel',
      ...
      {
        path: "complexAPI",
        loadComponent: () => import("./apisample.component-CTYGYX6S.js").then((m2) => m2.APISampleComponent)
      },
      {
        path: "pokeAPI",
        loadComponent: () => import("./pokemain.component-36VSBP34.js").then((m2) => m2.PokeMainComponent)
      },
      {
        path: "observableState",
        loadChildren: () => import("./observable-state.routes-OWD37OR3.js").then((m2) => m2.routes)
      },
      {
        path: "DirectiveSamp",
        loadComponent: () => import("./directives-sample.component-LFEHNEMF.js").then((m2) => m2.DirectivesSampleComponent)
      },
      {
        path: "svg",
        loadComponent: () => import("./svg-calender.component-RCI2TSKN.js").then((m2) => m2.SvgCalenderComponent)
      },
      {
        path: "testOb",
        loadChildren: () => import("./test.routes-RIYNZDQW.js").then((module) => module.routes)
      },
      {
        path: "home",
      ...
      {
        path: "dynhtml",
        loadComponent: () => import("./dynamichtml.component-LEYMQSH3.js").then((m2) => m2.DynamicHtmlComponent)
      },
      {
        path: "snow",
        loadComponent: () => import("./snow.component-4BEZN7K3.js").then((m2) => m2.SnowComponent)
      },
      {
        path: "tumblr",
        loadComponent: () => import("./tumblr.component-CDRCAW43.js").then((m2) => m2.TumblrComponent)
      },
      {
        path: "bigData",
        loadComponent: () => import("./big-data.component-CB4IUZWF.js").then((m2) => m2.BigDataComponent)
      },
      {
        path: "svgTest",
        loadComponent: () => import("./svg-test.component-XWMRNDQK.js").then((m2) => m2.SvgTestComponent)
      },
      {
        path: "pannel",
        loadComponent: () => import("./pannel-stuff.component-THY62CAP.js").then((m2) => m2.PannelStuffComponent)
      },
      {
        path: "clock",
        loadComponent: () => import("./analog-clock.component-OYTDI5CW.js").then((m2) => m2.AnalogClockComponent)
      },
      {
        path: "gridThings",
        loadComponent: () => import("./gridthings.component-DH3IYTHE.js").then((m2) => m2.GridthingsComponent)
      },
      {
        path: "bintree",
        loadComponent: () => import("./bintree.component-QVSXSTXJ.js").then((m2) => m2.BintreeComponent)
      },
      {
        path: "localState",
        loadChildren: () => import("./local-state.routes-WZC57STK.js").then((m2) => m2.routes)
      },
      {
        path: "lazyComponents",
        loadComponent: () => import("./lazy-component.component-3WIRQX2Y.js").then((m2) => m2.LazyComponentComponent)
      },
      {
        path: "svgTimer",
        loadComponent: () => import("./svg-timer.component-62UMRMZU.js").then((m2) => m2.SvgTimerComponent)
      },
      {
        path: "svgClock",
        loadComponent: () => import("./svg-clock.component-ERKVWRJ4.js").then((m2) => m2.SvgClockComponent)
      },
      {
        path: "dynForm",
        loadComponent: () => import("./dyn-form.component-EIFT7AME.js").then((m2) => m2.DynFormComponent)
      },
      {
        path: "rxjsTest",
        loadComponent: () => import("./rxjstest.component-DVP4QS6H.js").then((m2) => m2.RxjstestComponent)
      },
      {
        path: "unsubSample",
        loadComponent: () => import("./unsub-sample.component-DM5AHLPX.js").then((m2) => m2.UnsubSampleComponent)
      },
      {
        path: "unsubSample/:id",
        loadComponent: () => import("./unsub-sample.component-DM5AHLPX.js").then((m2) => m2.UnsubSampleComponent)
      },
      { path: "rvt", loadChildren: () => import("./routes-XKQ5WKAP.js") },
      {
        path: "gridCalender",
        loadComponent: () => import("./grid-calender.component-DB4QBBFU.js").then((m2) => m2.GridCalenderComponent)
      },
      {
        path: "summary",
        loadComponent: () => import("./html-summary.component-DFUSLA5F.js").then((m2) => m2.HtmlSummaryComponent)
      },
      {
        path: "resizePanel",
        loadComponent: () => import("./resizable-panels.component-NO432VRR.js").then((m2) => m2.ResizablePanelsComponent)
      },
      {
        path: "signalsInForm",
        loadComponent: () => import("./signals-form.component-IJ37O7Q5.js").then((m2) => m2.SignalsFormsComponent)
      },
      {
        path: "card",
        loadComponent: () => import("./card.component-7U7KIUM6.js").then((m2) => m2.CardComponent)
      },
      {
        path: "cells",
        loadComponent: () => import("./cells.component-DOCD2KG5.js").then((m2) => m2.CellsComponent)
      },
      {
        path: "cellsRaw",
        loadComponent: () => import("./cell-raw.component-JPHAUFN2.js").then((m2) => m2.CellRawComponent)
      },
      {
        path: "routeList",
        loadComponent: () => import("./route-list.component-MKGED2VG.js").then((m2) => m2.RouteListComponent)
      },
      {
        path: "formErrors",
        loadComponent: () => import("./form-error.component-5SMPLRZ3.js")
      },
      {
        path: "dialog",
        loadComponent: () => import("./dialog.component-UVYOJMIE.js")
      },
      {
        path: "signalInputMusings",
        loadComponent: () => import("./signal-input-musings.component-MHFE5YIO.js").then((m2) => m2.SignalInputMusingsComponent)
      },
      {
        path: "signalPlay",
        loadComponent: () => import("./signal-play.component-DN3DALOX.js")
      },
      // {
      //   path: 'signalError',
      ...
      {
        path: "eventedOutputs",
        loadComponent: () => import("./evented-outputs.component-ZQWX2THK.js").then((m2) => m2.EventedOutputsComponent)
      },
      {
        path: "indexDb",
        loadComponent: () => import("./indexdb.component-56L2O7AA.js").then((m2) => m2.IndexdbComponent),
        title: "IndexDb sample"
      },
      {
        path: "acnhorPosition",
        loadComponent: () => import("./anchor-pos.component-MCMBW7AO.js").then((m2) => m2.AnchorPosComponent),
        title: "Anchor Position demo"
      },
      {
        path: "outOfOrder",
        loadComponent: () => import("./out-of-order.component-BEISURDG.js").then((m2) => m2.OutOfOrderComponent)
      },
      {
        path: "stepper",
        loadComponent: () => import("./stepper.component-QOAQ4E32.js").then((m2) => m2.StepperComponent)
      },
      {
        path: "iconSprite",
        loadComponent: () => import("./icon-sprite.component-JCYWMKK2.js").then((m2) => m2.IconSpriteComponent)
      },
      {
        path: "reusableDialog",
        loadComponent: () => import("./reusable-dialog.component-NOIESFGA.js").then((m2) => m2.ReusableDialogComponent)
      },
      {
        path: "tableHover",
        loadComponent: () => import("./table-hover.component-UFHVKCH4.js").then((m2) => m2.TableHoverComponent)
      },
      {
        path: "signalDebounce",
        loadComponent: () => import("./signal-debounce.component-IEOXJ45C.js").then((m2) => m2.SignalDebounce)
      },
      {
        path: "crudStuff",
        loadComponent: () => import("./crud-stuff.component-FP6UUSAE.js").then((m2) => m2.CrudStuffComponent)
      },
      {
        path: "customNativeForm",
        loadComponent: () => import("./custom-native-form.component-BR4O4HZU.js").then((m2) => m2.CustomNativeFormComponent)
      },
      {
        path: "inputHostExperiment",
        loadComponent: () => import("./input-host-experiment.component-ATUGVQ72.js").then((m2) => m2.InputHostExperimentComponent)
      },
      {
        path: "meteredView",
        loadComponent: () => import("./metered-view.component-5DRM54BM.js").then((m2) => m2.MeteredViewComponent)
      },
      {
        path: "signalForms",
        loadComponent: () => import("./signal-forms-experiment.component-YXNGGKAO.js").then((m2) => m2.SignalFormsExperimentComponent)
      },
      {
        path: "signalForms/tree",
        loadComponent: () => import("./signal-tree.component-7BA3X5CM.js").then((m2) => m2.SignalTreeComponent)
      },
      {
        path: "signalForms/dynamic",
        loadComponent: () => import("./dynamic.component-PBWIM7BZ.js").then((m2) => m2.DynamicComponent)
      },
      {
        path: "toh",
        loadComponent: () => import("./toh.component-2NV4O24Z.js").then((m2) => m2.TohComponent)
      },
      {
        path: "toh/cdk",
        loadComponent: () => import("./toh-cdk.component-WBRW7OUI.js").then((m2) => m2.TohCdkComponent)
      },
      {
        path: "vt",
        loadComponent: () => import("./view-transitions.component-X3QACGGI.js").then((m2) => m2.ViewTransitionsComponent)
      },
      {
        path: "inMem",
        loadComponent: () => import("./in-mem-sample.component-REQPZIJL.js").then((m2) => m2.InMemSampleComponent)
      },
      {
        path: "dynSignalForm",
        loadComponent: () => import("./dynsignal-form.component-WKBQMZBF.js").then((m2) => m2.DynsignalFormComponent)
      },
      {
        path: "dyn-route",
        loadChildren: () => import("./dyn-routes.routes-LV7VTI26.js").then((m2) => m2.dynRoutes)
      },
      {
        path: "timer",
        loadComponent: () => import("./timer.component-LH3UCNV4.js").then((m2) => m2.TimerComponent)
      },
      {
        path: "temporal",
        loadComponent: () => import("./temporal.component-7FMHXONJ.js").then((m2) => m2.TemporalComponent)
      },
      {
        path: "gridPlay",
        loadComponent: () => import("./grid-play.component-KPS2XUVP.js").then((m2) => m2.GridPlayComponent)
      },
      {
        path: "caddy",
        loadComponent: () => import("./caddy.component-77JUO5OS.js").then((m2) => m2.CaddyComponent)
      },
      {
        path: "boxes",
        loadComponent: () => import("./boxes.component-DEDMCXU4.js").then((m2) => m2.BoxesComponent)
      },
      {
        path: "gamepad",
        loadComponent: () => import("./gamepad.component-X3KDEJK7.js").then((m2) => m2.GamepadComponent)
      },
      {
        path: "streamResource",
