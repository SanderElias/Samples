import{k as R,l as j}from"./chunk-7UTYY7SV.js";import{Gb as d,Ib as y,Jb as B,Kb as I,Lb as g,Sa as v,Wa as S,Za as c,eb as b,fb as i,ga as p,gb as r,hb as u,ia as f,o as x,ob as h,qb as E,rb as C,ub as s,y as w}from"./chunk-VWKE6EEO.js";import"./chunk-G5KKTNWD.js";var P=["*"],m=(()=>{let e=class{constructor(t){this.elmRef=t,this.shadowRoot=this.elmRef.nativeElement?.shadowRoot}},o=e;return(()=>{e.\u0275fac=function(n){return new(n||e)(c(v))}})(),(()=>{e.\u0275cmp=p({type:e,selectors:[["app-pannel"]],standalone:!0,features:[d],ngContentSelectors:P,decls:5,vars:0,consts:[[1,"pannel"]],template:function(n,a){n&1&&(E(),i(0,"div",0),u(1,"header"),i(2,"main"),C(3),r(),u(4,"footer"),r())},styles:[`
  .pannel {
    display:grid;
