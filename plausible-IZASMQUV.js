...
// node_modules/.pnpm/@plausible-analytics+tracker@0.4.5/node_modules/@plausible-analytics/tracker/plausible.js
var t;
var n;
var i;
var o = {};
...
function g() {
  ...
  if (!t && (f < i || e >= 3e3)) {
    f = i;
    var r = { n: "engagement", sd: Math.round(i / n * 100), d: o.domain, u: l, p: d, e, v: 34 };
    p = 0, v = 0, o.hashBasedRouting && (r.h = 1), s(o.endpoint, r);
  }
}
function b() {
...
function L() {
  var e, t2;
  return e = window.innerHeight, t2 = window.scrollY, n <= e ? n : t2 + e;
}
function S() {
  n = E(), i = L(), new ResizeObserver(function() {
    n = E();
...
function track(e, t2) {
  ...
  var r = {};
  r.n = e, r.v = 34;
  var a2 = t2 && (t2.u || t2.url);
  if (r.u = a2 || location.href, r.d = o.domain, r.r = document.referrer || null, t2 && t2.props && (r.p = t2.props), t2 && false === t2.interactive && (r.i = false), t2 && t2.revenue && (r.$ = t2.revenue), o.customProperties) {
    var n2 = o.customProperties;
    "function" == typeof n2 && (n2 = o.customProperties(e)), "object" == typeof n2 && (r.p = Object.assign({}, n2, r.p));
  }
  if (o.hashBasedRouting && (r.h = 1), "function" == typeof o.transformRequest && !(r = o.transformRequest(r))) return x(e, t2, "transformRequest");
  i2 && h(r), s(o.endpoint, r, t2);
}
function x(e, t2, n2) {
...
function T(e) {
  if ("auxclick" !== e.type || e.button === D) {
    ...
    if (!I(t2, 0)) {
      if (o.outboundLinks && O(t2)) return F(e, t2, { name: "Outbound Link: Click", props: { url: t2.href } });
      if (o.fileDownloads && z(n2)) return F(e, t2, { name: "File Download", props: { url: n2 } });
    }
  }
}
function F(e, t2, n2) {
...
function j(e) {
  ...
  for (var o2 = 0; o2 < i2.length; o2++) {
    var r, a2, u2 = i2.item(o2), s2 = u2.match(/plausible-event-(.+)(=|--)(.+)/);
    s2 && (r = s2[1], a2 = s2[3].replace(/\+/g, " "), "name" == r.toLowerCase() ? n2.name = a2 : n2.props[r] = a2);
    var c2 = u2.match(/plausible-revenue-(.+)(=|--)(.+)/);
    c2 && (r = c2[1], a2 = c2[3], n2.revenue[r] = a2);
  }
  return n2;
}
function A() {
  function e(e2) {
    if ("auxclick" !== e2.type || e2.button === D) {
      for (var t2, n2, i2, o2 = e2.target, r = 0; r <= _ && o2; r++) {
        if ((t2 = o2) && t2.tagName && "form" === t2.tagName.toLowerCase()) return;
        C(o2) && (n2 = o2), H(o2) && (i2 = o2), o2 = o2.parentNode;
      }
      if (i2) {
        var a2 = j(i2);
        if (n2) a2.props.url = n2.href, F(e2, n2, a2);
        else {
          var u2 = {};
          u2.props = a2.props, u2.revenue = a2.revenue, track(a2.name, u2);
        }
      }
    }
  }
  document.addEventListener("click", T), document.addEventListener("auxclick", T), o.fileDownloads && "object" == typeof o.fileDownloads && Array.isArray(o.fileDownloads.fileExtensions) && (N = o.fileDownloads.fileExtensions), o.formSubmissions && document.addEventListener("submit", function(e2) {
...
function init(e) {
  u(a(e || {})), S(), o.autoCapturePageviews && $(track), A(), o.bindToWindow && "undefined" != typeof window && (window.plausible = track, window.plausible.s = "npm", window.plausible.v = 34, window.plausible.l = true);
}
export {
  DEFAULT_FILE_TYPES,
  init,
