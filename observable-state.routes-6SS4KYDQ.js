...
var routes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./observable-state.component-ITGIJNPT.js").then((m) => m.ObservableStateComponent)
  }, false ? { \u0275entryName: "app/observable-state/observable-sate/observable-state.component.ts" } : {}),
  __spreadValues({
    path: "hook",
    loadComponent: () => import("./lifeycle-hooks-sample.component-ERQYG6NJ.js").then((m) => m.LifeycleHooksSampleComponent)
