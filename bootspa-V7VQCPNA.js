...
} from "./chunk-RI77EIII.js";
import {
  isGuardsCheckEnd,
  updateRouteInfo
} from "./chunk-TZX4MVCS.js";
import {
  toSignal
} from "./chunk-JNPCVYL6.js";
import {
  ActivatedRoute,
  Router,
  RouterOutlet,
...
} from "./chunk-ZSHI6P42.js";
import {
  HttpClient,
  provideHttpClient,
  withInterceptors
} from "./chunk-PXHX55HU.js";
...
// node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.3.1/node_modules/@fortawesome/free-solid-svg-icons/faPause.js
var require_faPause = __commonJS({
  "node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.3.1/node_modules/@fortawesome/free-solid-svg-icons/faPause.js"(exports) {
    "use strict";
...
// node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.3.1/node_modules/@fortawesome/free-solid-svg-icons/faPlay.js
var require_faPlay = __commonJS({
  "node_modules/.pnpm/@fortawesome+free-solid-svg-icons@7.3.1/node_modules/@fortawesome/free-solid-svg-icons/faPlay.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var prefix = "fas";
    var iconName = "play";
...
var AppService = class _AppService {
  constructor() {
    this.data = toSignal(inject(ActivatedRoute).url);
  }
  effect() {
    console.log("effect");
  ...
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineService({ token: _AppService, factory: _AppService.\u0275fac });
  }
};
(() => {
...
// src/app/util/metaData.service.ts
var MetaData = class {
};
var ClientMetaData = class _ClientMetaData {
  constructor() {
    this.currentRouteInfo$ = of(void 0);
  }
  static {
    this.\u0275fac = function ClientMetaData_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ClientMetaData)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ClientMetaData, factory: _ClientMetaData.\u0275fac });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ClientMetaData, [{
    type: Injectable
  }], null, null);
})();
var ServerMetaData = class _ServerMetaData {
  #http;
  #router;
  #routeData$;
  #blogList$;
  ...
  constructor() {
    ...
    this.#routeData$ = this.#http.get("/assets/routes.json");
    this.#blogList$ = this.#http.get("/assets/articles/articleList.json");
    this.#currentUrl$ = this.#router.events.pipe(filter(isGuardsCheckEnd), map((ev) => ev.url));
    this.currentRouteInfo$ = combineLatest([
      this.#routeData$,
      this.#blogList$,
      this.#currentUrl$
    ]).pipe(map(([routesData, blogList, url]) => {
      if (!routesData || !url) {
        return void 0;
      }
      let article;
      if (url.startsWith("/blog/")) {
        ...
        article = blogList.find((a2) => a2.id === blogId || a2.name === blogId);
        if (!article) {
          console.warn(`No article found for blogId ${blogId}`);
        }
      }
      const routeInfo = routesData.find((r2) => r2.path?.startsWith(url));
      if (!routeInfo) {
    ...
    this.#updateMetaTags = updateRouteInfo(inject(Meta), inject(Title));
  ...
  static {
    this.\u0275fac = function ServerMetaData_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ServerMetaData)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ServerMetaData, factory: _ServerMetaData.\u0275fac });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ServerMetaData, [{
    type: Injectable
  }], () => [], null);
})();
...
var routes = [
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./blogs.component-HOIFO422.js").then((m2) => m2.BlogsComponent)
  ...
  __spreadValues({
    path: "mqtt",
    loadChildren: () => import("./mqtt.routes-FJ3VL34H.js").then((m2) => m2.routes)
  }, false ? { \u0275entryName: "app/mqtt/mqtt.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./demo.component-Z5Y4U745.js").then((m2) => m2.DemoComponent),
    children: [
      {
        path: "filterSamp",
        data: {
        ...
        loadComponent: () => import("./filter-sample.component-ZCL3QG4G.js").then((m2) => m2.FilterSampleComponent)
      },
      {
        path: "modalSamp",
        loadComponent: () => import("./modal-demo.component-UJ7Q6BIX.js").then((m2) => m2.ModalDemoComponent)
      },
      {
        path: "mixinSamp",
        loadComponent: () => import("./mixins.component-O36SIAA7.js").then((m2) => m2.MixinsComponent)
      },
      {
        path: "htmlLoad",
        loadComponent: () => import("./htmlload.component-YSQ26ZKB.js").then((m2) => m2.HtmlloadComponent)
      },
      // {
      //   path: 'popup',
      //   outlet: 'popup',
      ...
      // },
      {
        ...
        loadComponent: () => import("./required-attributes.component-KGBIRKLP.js").then((m2) => m2.RequiredAttributesComponent)
      },
      // {
      //   path: 'viewModel',
      ...
      {
        path: "complexAPI",
        loadComponent: () => import("./apisample.component-S3FDYBZJ.js").then((m2) => m2.APISampleComponent)
      },
      {
        path: "pokeAPI",
        loadComponent: () => import("./pokemain.component-YLPLV4B2.js").then((m2) => m2.PokeMainComponent)
      },
      {
        path: "observableState",
        loadChildren: () => import("./observable-state.routes-QUUHONEZ.js").then((m2) => m2.routes)
      },
      {
        path: "DirectiveSamp",
        loadComponent: () => import("./directives-sample.component-HH7MGYNO.js").then((m2) => m2.DirectivesSampleComponent)
      },
      {
        path: "svg",
        loadComponent: () => import("./svg-calender.component-CWT4DJTI.js").then((m2) => m2.SvgCalenderComponent)
      },
      {
        path: "testOb",
        loadChildren: () => import("./test.routes-TYYCVQ7Y.js").then((module) => module.routes)
      },
      {
        path: "home",
      ...
      {
        path: "dynhtml",
        loadComponent: () => import("./dynamichtml.component-XKQABVCP.js").then((m2) => m2.DynamicHtmlComponent)
      },
      {
        path: "snow",
        loadComponent: () => import("./snow.component-36BABYYE.js").then((m2) => m2.SnowComponent)
      },
      {
        path: "tumblr",
        loadComponent: () => import("./tumblr.component-B7RQWX3V.js").then((m2) => m2.TumblrComponent)
      },
      {
        path: "bigData",
        loadComponent: () => import("./big-data.component-PORIJZ54.js").then((m2) => m2.BigDataComponent)
      },
      {
        path: "svgTest",
        loadComponent: () => import("./svg-test.component-CERA7O3D.js").then((m2) => m2.SvgTestComponent)
      },
      {
        path: "pannel",
        loadComponent: () => import("./pannel-stuff.component-WTWAGHQ2.js").then((m2) => m2.PannelStuffComponent)
      },
      {
        path: "clock",
        loadComponent: () => import("./analog-clock.component-STDNMTPE.js").then((m2) => m2.AnalogClockComponent)
      },
      {
        path: "gridThings",
        loadComponent: () => import("./gridthings.component-JPTLAXSC.js").then((m2) => m2.GridthingsComponent)
      },
      {
        path: "bintree",
        loadComponent: () => import("./bintree.component-TP74LELS.js").then((m2) => m2.BintreeComponent)
      },
      {
        path: "localState",
        loadChildren: () => import("./local-state.routes-RUXIOU6D.js").then((m2) => m2.routes)
      },
      {
        path: "lazyComponents",
        loadComponent: () => import("./lazy-component.component-AGYFWILN.js").then((m2) => m2.LazyComponentComponent)
      },
      {
        path: "svgTimer",
        loadComponent: () => import("./svg-timer.component-RA26ZQJS.js").then((m2) => m2.SvgTimerComponent)
      },
      {
        path: "svgClock",
        loadComponent: () => import("./svg-clock.component-DQWYMAFN.js").then((m2) => m2.SvgClockComponent)
      },
      {
        path: "dynForm",
        loadComponent: () => import("./dyn-form.component-C4GZTRFF.js").then((m2) => m2.DynFormComponent)
      },
      {
        path: "rxjsTest",
        loadComponent: () => import("./rxjstest.component-VQ2FE3XY.js").then((m2) => m2.RxjstestComponent)
      },
      {
        path: "unsubSample",
        loadComponent: () => import("./unsub-sample.component-FZU5IAV5.js").then((m2) => m2.UnsubSampleComponent)
      },
      {
        path: "unsubSample/:id",
        loadComponent: () => import("./unsub-sample.component-FZU5IAV5.js").then((m2) => m2.UnsubSampleComponent)
      },
      { path: "rvt", loadChildren: () => import("./routes-Y6J4ATMX.js") },
      {
        path: "gridCalender",
        loadComponent: () => import("./grid-calender.component-Z3VZ64KE.js").then((m2) => m2.GridCalenderComponent)
      },
      {
        path: "summary",
        loadComponent: () => import("./html-summary.component-SQ2JY3EK.js").then((m2) => m2.HtmlSummaryComponent)
      },
      {
        path: "resizePanel",
        loadComponent: () => import("./resizable-panels.component-I3YSYPGL.js").then((m2) => m2.ResizablePanelsComponent)
      },
      {
        path: "signalsInForm",
        loadComponent: () => import("./signals-form.component-4OOP6QOW.js").then((m2) => m2.SignalsFormsComponent)
      },
      {
        path: "card",
        loadComponent: () => import("./card.component-7OT4H73N.js").then((m2) => m2.CardComponent)
      },
      {
        path: "cells",
        loadComponent: () => import("./cells.component-NQKGLF5P.js").then((m2) => m2.CellsComponent)
      },
      {
        path: "cellsRaw",
        loadComponent: () => import("./cell-raw.component-6P3RBYAP.js").then((m2) => m2.CellRawComponent)
      },
      {
        path: "routeList",
        loadComponent: () => import("./route-list.component-5D5D3B5U.js").then((m2) => m2.RouteListComponent)
      },
      {
        path: "formErrors",
        loadComponent: () => import("./form-error.component-AZ7YCNMT.js")
      },
      {
        path: "dialog",
        loadComponent: () => import("./dialog.component-VXMWUUH7.js")
      },
      {
        path: "signalInputMusings",
        loadComponent: () => import("./signal-input-musings.component-BTLRLTAK.js").then((m2) => m2.SignalInputMusingsComponent)
      },
      {
        path: "signalPlay",
        loadComponent: () => import("./signal-play.component-VWWZW3VC.js")
      },
      // {
      //   path: 'signalError',
      ...
      {
        path: "eventedOutputs",
        loadComponent: () => import("./evented-outputs.component-DGFZQTU3.js").then((m2) => m2.EventedOutputsComponent)
      },
      {
        path: "indexDb",
        loadComponent: () => import("./indexdb.component-DDIPP7PM.js").then((m2) => m2.IndexdbComponent),
        title: "IndexDb sample"
      },
      {
        path: "acnhorPosition",
        loadComponent: () => import("./anchor-pos.component-FNZAC7TF.js").then((m2) => m2.AnchorPosComponent),
        title: "Anchor Position demo"
      },
      {
        path: "outOfOrder",
        loadComponent: () => import("./out-of-order.component-2QHHPHGQ.js").then((m2) => m2.OutOfOrderComponent)
      },
      {
        path: "stepper",
        loadComponent: () => import("./stepper.component-3AKEOVIV.js").then((m2) => m2.StepperComponent)
      },
      {
        path: "iconSprite",
        loadComponent: () => import("./icon-sprite.component-5UL3QDMD.js").then((m2) => m2.IconSpriteComponent)
      },
      {
        path: "reusableDialog",
        loadComponent: () => import("./reusable-dialog.component-PYFYVDZA.js").then((m2) => m2.ReusableDialogComponent)
      },
      {
        path: "tableHover",
        loadComponent: () => import("./table-hover.component-VUQAFET3.js").then((m2) => m2.TableHoverComponent)
      },
      {
        path: "signalDebounce",
        loadComponent: () => import("./signal-debounce.component-2KYVEPCJ.js").then((m2) => m2.SignalDebounce)
      },
      {
        path: "crudStuff",
        loadComponent: () => import("./crud-stuff.component-ZQU5RP2J.js").then((m2) => m2.CrudStuffComponent)
      },
      {
        path: "customNativeForm",
        loadComponent: () => import("./custom-native-form.component-GBKKRET3.js").then((m2) => m2.CustomNativeFormComponent)
      },
      {
        path: "inputHostExperiment",
        loadComponent: () => import("./input-host-experiment.component-6QO7BXMO.js").then((m2) => m2.InputHostExperimentComponent)
      },
      {
        path: "meteredView",
        loadComponent: () => import("./metered-view.component-MATRODJX.js").then((m2) => m2.MeteredViewComponent)
      },
      {
        path: "signalForms",
        loadComponent: () => import("./signal-forms-experiment.component-VWEK5JP2.js").then((m2) => m2.SignalFormsExperimentComponent)
      },
      {
        path: "signalForms/tree",
        loadComponent: () => import("./signal-tree.component-CUJFZXK2.js").then((m2) => m2.SignalTreeComponent)
      },
      {
        path: "signalForms/dynamic",
        loadComponent: () => import("./dynamic.component-UPBSHZJ2.js").then((m2) => m2.DynamicComponent)
      },
      {
        path: "toh",
        loadComponent: () => import("./toh.component-37SD22HN.js").then((m2) => m2.TohComponent)
      },
      {
        path: "toh/cdk",
        loadComponent: () => import("./toh-cdk.component-V3DJUIF7.js").then((m2) => m2.TohCdkComponent)
      },
      {
        path: "vt",
        loadComponent: () => import("./view-transitions.component-XZ7TPYCL.js").then((m2) => m2.ViewTransitionsComponent)
      },
      {
        path: "inMem",
        loadComponent: () => import("./in-mem-sample.component-ZJIQGL4X.js").then((m2) => m2.InMemSampleComponent)
      },
      {
        path: "dynSignalForm",
        loadComponent: () => import("./dynsignal-form.component-WZ5J6KOV.js").then((m2) => m2.DynsignalFormComponent)
      },
      {
        path: "dyn-route",
        loadChildren: () => import("./dyn-routes.routes-T2BX6THY.js").then((m2) => m2.dynRoutes)
      },
      {
        path: "timer",
        loadComponent: () => import("./timer.component-S76NRPEH.js").then((m2) => m2.TimerComponent)
      },
      {
        path: "temporal",
        loadComponent: () => import("./temporal.component-PBH3HSNG.js").then((m2) => m2.TemporalComponent)
      },
      {
        path: "gridPlay",
        loadComponent: () => import("./grid-play.component-MYOEX6K7.js").then((m2) => m2.GridPlayComponent)
      },
      {
        path: "caddy",
        loadComponent: () => import("./caddy.component-XRFCCSQT.js").then((m2) => m2.CaddyComponent)
      },
      {
        path: "boxes",
        loadComponent: () => import("./boxes.component-ICVUTCVS.js").then((m2) => m2.BoxesComponent)
      },
      {
        path: "gamepad",
        loadComponent: () => import("./gamepad.component-WD7UNYM5.js").then((m2) => m2.GamepadComponent)
      },
      {
        path: "streamResource",
        loadComponent: () => import("./stream-resource.component-ZXD46EXL.js").then((m2) => m2.StreamResourceComponent)
      },
      { path: "**", redirectTo: "routeList" }
    ]
  }, false ? { \u0275entryName: "app/demo.component.ts" } : {})
];
...
// src/bootspa.ts
library$1.add(import_faPlay.faPlay, import_faPause.faPause);
dom$1.watch();
